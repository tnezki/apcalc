...
# ============================================================================
# UNIT 4 BANK GENERATED FIGURES - APPENDED BELOW FINAL APPROVED MARKER
# ============================================================================

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_context_graph(ax, [
    {'expr': lambda x: (0.0)*x**3+(0.30000000000000004)*x**2+(3.0)*x+(3.0), 'deriv': lambda x: 3*(0.0)*x**2+2*(0.30000000000000004)*x+(3.0), 'color': 'steelblue', 'label': None}
], xmin=0, xmax=8, ymin=-10, ymax=30, xlabel='Time (s)', ylabel='Velocity (m/s)', title='')
save_graph(fig, 'u4_fa_d3_02_v1_motion_synthesis.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_context_graph(ax, [
    {'expr': lambda x: (0.0)*x**3+(0.44999999999999996)*x**2+(-1.0)*x+(3.0), 'deriv': lambda x: 3*(0.0)*x**2+2*(0.44999999999999996)*x+(-1.0), 'color': 'steelblue', 'label': None}
], xmin=0, xmax=8, ymin=-10, ymax=30, xlabel='Time (s)', ylabel='Velocity (m/s)', title='')
save_graph(fig, 'u4_fa_d3_02_v2_motion_synthesis.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_context_graph(ax, [
    {'expr': lambda x: (0.0)*x**3+(-0.44999999999999996)*x**2+(-1.0)*x+(2.0), 'deriv': lambda x: 3*(0.0)*x**2+2*(-0.44999999999999996)*x+(-1.0), 'color': 'steelblue', 'label': None}
], xmin=0, xmax=8, ymin=-10, ymax=30, xlabel='Time (s)', ylabel='Velocity (m/s)', title='')
save_graph(fig, 'u4_fa_d3_02_v3_motion_synthesis.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_context_graph(ax, [
    {'expr': lambda x: (0.0)*x**3+(0.30000000000000004)*x**2+(2.0)*x+(3.0), 'deriv': lambda x: 3*(0.0)*x**2+2*(0.30000000000000004)*x+(2.0), 'color': 'steelblue', 'label': None}
], xmin=0, xmax=8, ymin=-10, ymax=30, xlabel='Time (s)', ylabel='Velocity (m/s)', title='')
save_graph(fig, 'u4_fa_d3_02_v4_motion_synthesis.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_context_graph(ax, [
    {'expr': lambda x: (0.0)*x**3+(0.6000000000000001)*x**2+(-1.0)*x+(5.0), 'deriv': lambda x: 3*(0.0)*x**2+2*(0.6000000000000001)*x+(-1.0), 'color': 'steelblue', 'label': None}
], xmin=0, xmax=8, ymin=-10, ymax=30, xlabel='Time (s)', ylabel='Velocity (m/s)', title='')
save_graph(fig, 'u4_fa_d3_02_v5_motion_synthesis.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_context_graph(ax, [
    {'expr': lambda x: (0.0)*x**3+(0.44999999999999996)*x**2+(2.0)*x+(3.0), 'deriv': lambda x: 3*(0.0)*x**2+2*(0.44999999999999996)*x+(2.0), 'color': 'steelblue', 'label': None}
], xmin=0, xmax=8, ymin=-10, ymax=30, xlabel='Time (s)', ylabel='Velocity (m/s)', title='')
save_graph(fig, 'u4_fa_d3_02_v6_motion_synthesis.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_context_graph(ax, [
    {'expr': lambda x: (0.0)*x**3+(-0.30000000000000004)*x**2+(-3.0)*x+(2.0), 'deriv': lambda x: 3*(0.0)*x**2+2*(-0.30000000000000004)*x+(-3.0), 'color': 'steelblue', 'label': None}
], xmin=0, xmax=8, ymin=-10, ymax=30, xlabel='Time (s)', ylabel='Velocity (m/s)', title='')
save_graph(fig, 'u4_fa_d3_02_v7_motion_synthesis.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_context_graph(ax, [
    {'expr': lambda x: (0.0)*x**3+(-0.6000000000000001)*x**2+(-3.0)*x+(5.0), 'deriv': lambda x: 3*(0.0)*x**2+2*(-0.6000000000000001)*x+(-3.0), 'color': 'steelblue', 'label': None}
], xmin=0, xmax=8, ymin=-10, ymax=30, xlabel='Time (s)', ylabel='Velocity (m/s)', title='')
save_graph(fig, 'u4_fa_d3_02_v8_motion_synthesis.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: (0.5)*x**2+(0), 'deriv': lambda x: 2*(0.5)*x, 'color': 'steelblue', 'label': 'f'},
    {'expr': lambda x: (-2.0)*x+(-2.0), 'deriv': lambda x: np.zeros_like(x,dtype=float)+(-2.0), 'color': 'firebrick', 'label': 'L'}
], title='')
save_graph(fig, 'u4_fa_d4_03_v1_local_experiment.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: (0.5)*x**2+(-2), 'deriv': lambda x: 2*(0.5)*x, 'color': 'steelblue', 'label': 'f'},
    {'expr': lambda x: (-2.0)*x+(-4.0), 'deriv': lambda x: np.zeros_like(x,dtype=float)+(-2.0), 'color': 'firebrick', 'label': 'L'}
], title='')
save_graph(fig, 'u4_fa_d4_03_v2_local_experiment.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: (0.35)*x**2+(-1), 'deriv': lambda x: 2*(0.35)*x, 'color': 'steelblue', 'label': 'f'},
    {'expr': lambda x: (0.7)*x+(-1.35), 'deriv': lambda x: np.zeros_like(x,dtype=float)+(0.7), 'color': 'firebrick', 'label': 'L'}
], title='')
save_graph(fig, 'u4_fa_d4_03_v3_local_experiment.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: (0.75)*x**2+(0), 'deriv': lambda x: 2*(0.75)*x, 'color': 'steelblue', 'label': 'f'},
    {'expr': lambda x: (-1.5)*x+(-0.75), 'deriv': lambda x: np.zeros_like(x,dtype=float)+(-1.5), 'color': 'firebrick', 'label': 'L'}
], title='')
save_graph(fig, 'u4_fa_d4_03_v4_local_experiment.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: (0.75)*x**2+(1), 'deriv': lambda x: 2*(0.75)*x, 'color': 'steelblue', 'label': 'f'},
    {'expr': lambda x: (-3.0)*x+(-2.0), 'deriv': lambda x: np.zeros_like(x,dtype=float)+(-3.0), 'color': 'firebrick', 'label': 'L'}
], title='')
save_graph(fig, 'u4_fa_d4_03_v5_local_experiment.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: (0.25)*x**2+(2), 'deriv': lambda x: 2*(0.25)*x, 'color': 'steelblue', 'label': 'f'},
    {'expr': lambda x: (-1.0)*x+(1.0), 'deriv': lambda x: np.zeros_like(x,dtype=float)+(-1.0), 'color': 'firebrick', 'label': 'L'}
], title='')
save_graph(fig, 'u4_fa_d4_03_v6_local_experiment.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: (0.25)*x**2+(1), 'deriv': lambda x: 2*(0.25)*x, 'color': 'steelblue', 'label': 'f'},
    {'expr': lambda x: (0.5)*x+(0.75), 'deriv': lambda x: np.zeros_like(x,dtype=float)+(0.5), 'color': 'firebrick', 'label': 'L'}
], title='')
save_graph(fig, 'u4_fa_d4_03_v7_local_experiment.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: (0.35)*x**2+(0), 'deriv': lambda x: 2*(0.35)*x, 'color': 'steelblue', 'label': 'f'},
    {'expr': lambda x: (-0.7)*x+(-0.35), 'deriv': lambda x: np.zeros_like(x,dtype=float)+(-0.7), 'color': 'firebrick', 'label': 'L'}
], title='')
save_graph(fig, 'u4_fa_d4_03_v8_local_experiment.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_context_graph(ax, [
    {'expr': lambda x: (-0.15)*x**3+(1.5)*x**2+(5.0)*x+(2.0), 'deriv': lambda x: 3*(-0.15)*x**2+2*(1.5)*x+(5.0), 'color': 'steelblue', 'label': None}
], xmin=0, xmax=8, ymin=-10, ymax=30, xlabel='Time (s)', ylabel='Position (m)', title='')
save_graph(fig, 'u4_s2_et_c_c01_position_graph.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_context_graph(ax, [
    {'expr': lambda x: (0.0)*x**3+(0.30000000000000004)*x**2+(-1.0)*x+(5.0), 'deriv': lambda x: 3*(0.0)*x**2+2*(0.30000000000000004)*x+(-1.0), 'color': 'steelblue', 'label': None}
], xmin=0, xmax=8, ymin=-10, ymax=30, xlabel='Time (s)', ylabel='Velocity (m/s)', title='')
save_graph(fig, 'u4_s2_ps2_c02_velocity_graph.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_context_graph(ax, [
    {'expr': lambda x: (-0.1)*x**3+(-0.5)*x**2+(4.0)*x+(2.0), 'deriv': lambda x: 3*(-0.1)*x**2+2*(-0.5)*x+(4.0), 'color': 'steelblue', 'label': None}
], xmin=0, xmax=8, ymin=-10, ymax=30, xlabel='Time (s)', ylabel='Position (m)', title='')
save_graph(fig, 'u4_s2_ps2_c03_position_graph.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_context_graph(ax, [
    {'expr': lambda x: (0.0)*x**3+(0.6000000000000001)*x**2+(-2.0)*x+(5.0), 'deriv': lambda x: 3*(0.0)*x**2+2*(0.6000000000000001)*x+(-2.0), 'color': 'steelblue', 'label': None}
], xmin=0, xmax=8, ymin=-10, ymax=30, xlabel='Time (s)', ylabel='Velocity (m/s)', title='')
save_graph(fig, 'u4_s2_wu3_c01_velocity_graph.png')
plt.close(fig)
...
save_graph(fig, 'u4_s2_xp_c02_velocity_graph.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_context_graph(ax, [
    {'expr': lambda x: (-0.1)*x**3+(-1.5)*x**2+(5.0)*x+(6.0), 'deriv': lambda x: 3*(-0.1)*x**2+2*(-1.5)*x+(5.0), 'color': 'steelblue', 'label': None}
], xmin=0, xmax=8, ymin=-10, ymax=30, xlabel='Time (s)', ylabel='Position (m)', title='')
save_graph(fig, 'u4_s2_xp_c03_position_graph.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_context_graph(ax, [
    {'expr': lambda x: (0.0)*x**3+(0.6000000000000001)*x**2+(1.0)*x+(2.0), 'deriv': lambda x: 3*(0.0)*x**2+2*(0.6000000000000001)*x+(1.0), 'color': 'steelblue', 'label': None}
], xmin=0, xmax=8, ymin=-10, ymax=30, xlabel='Time (s)', ylabel='Velocity (m/s)', title='')
save_graph(fig, 'u4_s3_ps1_l01_velocity_graph.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_context_graph(ax, [
    {'expr': lambda x: (-0.15)*x**3+(-0.5)*x**2+(3.0)*x+(2.0), 'deriv': lambda x: 3*(-0.15)*x**2+2*(-0.5)*x+(3.0), 'color': 'steelblue', 'label': None}
], xmin=0, xmax=8, ymin=-10, ymax=30, xlabel='Time (s)', ylabel='Position (m)', title='')
save_graph(fig, 'u4_s3_ps1_l02_position_graph.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_context_graph(ax, [
    {'expr': lambda x: (0.0)*x**3+(0.30000000000000004)*x**2+(-3.0)*x+(5.0), 'deriv': lambda x: 3*(0.0)*x**2+2*(0.30000000000000004)*x+(-3.0), 'color': 'steelblue', 'label': None}
], xmin=0, xmax=8, ymin=-10, ymax=30, xlabel='Time (s)', ylabel='Velocity (m/s)', title='')
save_graph(fig, 'u4_s3_ps2_l05_velocity_graph.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_context_graph(ax, [
    {'expr': lambda x: (0.0)*x**3+(-0.30000000000000004)*x**2+(3.0)*x+(4.0), 'deriv': lambda x: 3*(0.0)*x**2+2*(-0.30000000000000004)*x+(3.0), 'color': 'steelblue', 'label': None}
], xmin=0, xmax=8, ymin=-10, ymax=30, xlabel='Time (s)', ylabel='Velocity (m/s)', title='')
save_graph(fig, 'u4_s3_wu1_l01_velocity_graph.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_context_graph(ax, [
    {'expr': lambda x: (-0.2)*x**3+(1.0)*x**2+(2.0)*x+(2.0), 'deriv': lambda x: 3*(-0.2)*x**2+2*(1.0)*x+(2.0), 'color': 'steelblue', 'label': None}
], xmin=0, xmax=8, ymin=-10, ymax=30, xlabel='Time (s)', ylabel='Position (m)', title='')
save_graph(fig, 'u4_s3_wu2_l01_position_graph.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_context_graph(ax, [
    {'expr': lambda x: (0.0)*x**3+(-0.44999999999999996)*x**2+(-3.0)*x+(4.0), 'deriv': lambda x: 3*(0.0)*x**2+2*(-0.44999999999999996)*x+(-3.0), 'color': 'steelblue', 'label': None}
], xmin=0, xmax=8, ymin=-10, ymax=30, xlabel='Time (s)', ylabel='Velocity (m/s)', title='')
save_graph(fig, 'u4_s3_xp_l05_velocity_graph.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: (0.5)*x**2+(2), 'deriv': lambda x: 2*(0.5)*x, 'color': 'steelblue', 'label': 'f'},
    {'expr': lambda x: (-2.0)*x+(0.0), 'deriv': lambda x: np.zeros_like(x,dtype=float)+(-2.0), 'color': 'firebrick', 'label': 'L'}
], title='')
save_graph(fig, 'u4_s5_note_ex03_local_linearity.png')
plt.close(fig)
...
save_graph(fig, 'u4_s5_note_yti03_local_linearity.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: (0.35)*x**2+(2), 'deriv': lambda x: 2*(0.35)*x, 'color': 'steelblue', 'label': 'f'},
    {'expr': lambda x: (-0.7)*x+(1.6500000000000001), 'deriv': lambda x: np.zeros_like(x,dtype=float)+(-0.7), 'color': 'firebrick', 'label': 'L'}
], title='')
save_graph(fig, 'u4_s5_perf01_linearization_model.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: (0.5)*x**2+(0), 'deriv': lambda x: 2*(0.5)*x, 'color': 'steelblue', 'label': 'f'},
    {'expr': lambda x: (1.0)*x+(-0.5), 'deriv': lambda x: np.zeros_like(x,dtype=float)+(1.0), 'color': 'firebrick', 'label': 'L'}
], title='')
save_graph(fig, 'u4_s5_ps1_c03_local_linearity.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_context_graph(ax, [
    {'expr': lambda x: (0.0)*x**3+(-0.6000000000000001)*x**2+(-2.0)*x+(4.0), 'deriv': lambda x: 3*(0.0)*x**2+2*(-0.6000000000000001)*x+(-2.0), 'color': 'steelblue', 'label': None}
], xmin=0, xmax=8, ymin=-10, ymax=30, xlabel='Time (s)', ylabel='Velocity (m/s)', title='')
save_graph(fig, 'u4_sum_v1_q08_summative_velocity.png')
plt.close(fig)
...
save_graph(fig, 'u4_sum_v2_q08_summative_velocity.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_context_graph(ax, [
    {'expr': lambda x: (0.0)*x**3+(-0.30000000000000004)*x**2+(2.0)*x+(4.0), 'deriv': lambda x: 3*(0.0)*x**2+2*(-0.30000000000000004)*x+(2.0), 'color': 'steelblue', 'label': None}
], xmin=0, xmax=8, ymin=-10, ymax=30, xlabel='Time (s)', ylabel='Velocity (m/s)', title='')
save_graph(fig, 'u4_sum_v3_q08_summative_velocity.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_context_graph(ax, [
    {'expr': lambda x: (0.0)*x**3+(0.30000000000000004)*x**2+(-2.0)*x+(2.0), 'deriv': lambda x: 3*(0.0)*x**2+2*(0.30000000000000004)*x+(-2.0), 'color': 'steelblue', 'label': None}
], xmin=0, xmax=8, ymin=-10, ymax=30, xlabel='Time (s)', ylabel='Velocity (m/s)', title='')
save_graph(fig, 'u4_sum_v4_q08_summative_velocity.png')
plt.close(fig)
...
save_graph(fig, 'u4_sum_v5_q08_summative_velocity.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_context_graph(ax, [
    {'expr': lambda x: (0.0)*x**3+(-0.44999999999999996)*x**2+(-3.0)*x+(3.0), 'deriv': lambda x: 3*(0.0)*x**2+2*(-0.44999999999999996)*x+(-3.0), 'color': 'steelblue', 'label': None}
], xmin=0, xmax=8, ymin=-10, ymax=30, xlabel='Time (s)', ylabel='Velocity (m/s)', title='')
save_graph(fig, 'u4_sum_v6_q08_summative_velocity.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_context_graph(ax, [
    {'expr': lambda x: (0.0)*x**3+(-0.44999999999999996)*x**2+(-1.0)*x+(4.0), 'deriv': lambda x: 3*(0.0)*x**2+2*(-0.44999999999999996)*x+(-1.0), 'color': 'steelblue', 'label': None}
], xmin=0, xmax=8, ymin=-10, ymax=30, xlabel='Time (s)', ylabel='Velocity (m/s)', title='')
save_graph(fig, 'u4_sum_v7_q08_summative_velocity.png')
plt.close(fig)
...
save_graph(fig, 'u4_sum_v8_q08_summative_velocity.png')
plt.close(fig)
