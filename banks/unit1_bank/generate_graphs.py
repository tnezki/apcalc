...
# =============================================================================
# UNIT 1 BANK GRAPH-GENERATION BLOCKS - APPENDED ONLY
# Generated from bank mapping. No graph-tool source above this block is modified.
# =============================================================================

GRAPH_SPECS = [{'kind': 'smooth', 'filename': 'u1_s1_wtc01_secant_preview.png', 'vx': 1, 'vy': 2}, {'kind': 'piecewise', 'filename': 'u1_s2_wtc01_graph_table_preview.png', 'a': 2, 'left': 5, 'right': 5, 'point': 1, 'm1': 0.6, 'm2': -0.4}, {'kind': 'piecewise', 'filename': 'u1_s1_ps1_q04_point_vs_limit.png', 'a': 2, 'left': 3, 'right': 3, 'point': 6, 'm1': 0.5, 'm2': -0.3}, {'kind': 'piecewise', 'filename': 'u1_s1_ps1_q16_approach_graph.png', 'a': 0, 'left': 3, 'right': 3, 'point': None, 'm1': 0.7, 'm2': 0.2}, {'kind': 'piecewise', 'filename': 'u1_s1_ps2_q04_point_vs_limit.png', 'a': 1, 'left': 4, 'right': 4, 'point': 7, 'm1': 0.5, 'm2': -0.3}, {'kind': 'piecewise', 'filename': 'u1_s1_ps2_q16_approach_graph.png', 'a': 1, 'left': 3, 'right': 3, 'point': None, 'm1': 0.7, 'm2': 0.2}, {'kind': 'piecewise', 'filename': 'u1_s1_ps3_q04_point_vs_limit.png', 'a': 2, 'left': 5, 'right': 5, 'point': 8, 'm1': 0.5, 'm2': -0.3}, {'kind': 'piecewise', 'filename': 'u1_s1_ps3_q16_approach_graph.png', 'a': 2, 'left': 3, 'right': 3, 'point': None, 'm1': 0.7, 'm2': 0.2}, {'kind': 'piecewise', 'filename': 'u1_s1_xp_q04_point_vs_limit.png', 'a': 1, 'left': 6, 'right': 6, 'point': 9, 'm1': 0.5, 'm2': -0.3}, {'kind': 'piecewise', 'filename': 'u1_s1_xp_q16_approach_graph.png', 'a': 3, 'left': 3, 'right': 3, 'point': None, 'm1': 0.7, 'm2': 0.2}, {'kind': 'piecewise', 'filename': 'u1_s2_ps1_q04_one_sided.png', 'a': 2, 'left': 3, 'right': 5, 'point': None, 'm1': 0.5, 'm2': -0.4}, {'kind': 'piecewise', 'filename': 'u1_s2_ps1_q07_hole_point.png', 'a': 1, 'left': 3, 'right': 3, 'point': 7, 'm1': 0.2, 'm2': 0.6}, {'kind': 'piecewise', 'filename': 'u1_s2_ps1_q15_two_sided.png', 'a': 1, 'left': 3, 'right': 3, 'point': None, 'm1': -0.7, 'm2': 0.7}, {'kind': 'piecewise', 'filename': 'u1_s2_ps2_q04_one_sided.png', 'a': 3, 'left': 4, 'right': 6, 'point': None, 'm1': 0.5, 'm2': -0.4}, {'kind': 'piecewise', 'filename': 'u1_s2_ps2_q07_hole_point.png', 'a': 2, 'left': 4, 'right': 4, 'point': 8, 'm1': 0.2, 'm2': 0.6}, {'kind': 'piecewise', 'filename': 'u1_s2_ps2_q15_two_sided.png', 'a': 2, 'left': 4, 'right': 4, 'point': None, 'm1': -0.7, 'm2': 0.7}, {'kind': 'piecewise', 'filename': 'u1_s2_ps3_q04_one_sided.png', 'a': 4, 'left': 2, 'right': 4, 'point': None, 'm1': 0.5, 'm2': -0.4}, {'kind': 'piecewise', 'filename': 'u1_s2_ps3_q07_hole_point.png', 'a': 3, 'left': 2, 'right': 2, 'point': 6, 'm1': 0.2, 'm2': 0.6}, {'kind': 'piecewise', 'filename': 'u1_s2_ps3_q15_two_sided.png', 'a': 3, 'left': 2, 'right': 2, 'point': None, 'm1': -0.7, 'm2': 0.7}, {'kind': 'piecewise', 'filename': 'u1_s2_xp_q04_one_sided.png', 'a': 1, 'left': 3, 'right': 5, 'point': None, 'm1': 0.5, 'm2': -0.4}, {'kind': 'piecewise', 'filename': 'u1_s2_xp_q07_hole_point.png', 'a': 4, 'left': 3, 'right': 3, 'point': 7, 'm1': 0.2, 'm2': 0.6}, {'kind': 'piecewise', 'filename': 'u1_s2_xp_q15_two_sided.png', 'a': 4, 'left': 3, 'right': 3, 'point': None, 'm1': -0.7, 'm2': 0.7}, {'kind': 'piecewise', 'filename': 'u1_s4_ps1_q04_jump_graph.png', 'a': 2, 'left': 2, 'right': 5, 'point': 2, 'm1': 0.3, 'm2': -0.4}, {'kind': 'piecewise', 'filename': 'u1_s4_ps2_q04_jump_graph.png', 'a': 3, 'left': 3, 'right': 6, 'point': 3, 'm1': 0.3, 'm2': -0.4}, {'kind': 'piecewise', 'filename': 'u1_s4_ps3_q04_jump_graph.png', 'a': 1, 'left': 4, 'right': 7, 'point': 4, 'm1': 0.3, 'm2': -0.4}, {'kind': 'piecewise', 'filename': 'u1_s4_xp_q04_jump_graph.png', 'a': 2, 'left': 5, 'right': 8, 'point': 5, 'm1': 0.3, 'm2': -0.4}, {'kind': 'rational', 'filename': 'u1_s5_ps1_q03_asymptote_evidence.png', 'a': 2, 'h': 0, 'scale': 3}, {'kind': 'rational', 'filename': 'u1_s5_ps2_q03_asymptote_evidence.png', 'a': 3, 'h': 1, 'scale': 4}, {'kind': 'rational', 'filename': 'u1_s5_ps3_q03_asymptote_evidence.png', 'a': 4, 'h': 2, 'scale': 5}, {'kind': 'rational', 'filename': 'u1_s5_xp_q03_asymptote_evidence.png', 'a': 5, 'h': 3, 'scale': 6}, {'kind': 'piecewise', 'filename': 'u1_fa_d1_02_v1_formative_one_sided.png', 'a': 1, 'left': -1, 'right': 3, 'point': None, 'm1': 0.4, 'm2': -0.5}, {'kind': 'piecewise', 'filename': 'u1_fa_d1_02_v3_formative_one_sided.png', 'a': 3, 'left': 1, 'right': 5, 'point': None, 'm1': 0.4, 'm2': -0.5}, {'kind': 'piecewise', 'filename': 'u1_fa_d1_02_v5_formative_one_sided.png', 'a': 5, 'left': 3, 'right': 7, 'point': None, 'm1': 0.4, 'm2': -0.5}, {'kind': 'piecewise', 'filename': 'u1_fa_d1_02_v7_formative_one_sided.png', 'a': 7, 'left': 5, 'right': 9, 'point': None, 'm1': 0.4, 'm2': -0.5}, {'kind': 'piecewise', 'filename': 'u1_fa_d2_01_v1_graph_table_match.png', 'a': 1, 'left': 3, 'right': 3, 'point': 8, 'm1': 0.5, 'm2': -0.3}, {'kind': 'piecewise', 'filename': 'u1_fa_d2_01_v2_graph_table_match.png', 'a': 2, 'left': 4, 'right': 4, 'point': 9, 'm1': 0.5, 'm2': -0.3}, {'kind': 'piecewise', 'filename': 'u1_fa_d2_01_v3_graph_table_match.png', 'a': 3, 'left': 5, 'right': 7, 'point': 10, 'm1': 0.5, 'm2': -0.3}, {'kind': 'piecewise', 'filename': 'u1_fa_d2_01_v4_graph_table_match.png', 'a': 4, 'left': 6, 'right': 6, 'point': 11, 'm1': 0.5, 'm2': -0.3}, {'kind': 'piecewise', 'filename': 'u1_fa_d2_01_v5_graph_table_match.png', 'a': 5, 'left': 7, 'right': 7, 'point': 12, 'm1': 0.5, 'm2': -0.3}, {'kind': 'piecewise', 'filename': 'u1_fa_d2_01_v6_graph_table_match.png', 'a': 6, 'left': 8, 'right': 10, 'point': 13, 'm1': 0.5, 'm2': -0.3}, {'kind': 'piecewise', 'filename': 'u1_fa_d2_01_v7_graph_table_match.png', 'a': 7, 'left': 9, 'right': 9, 'point': 14, 'm1': 0.5, 'm2': -0.3}, {'kind': 'piecewise', 'filename': 'u1_fa_d2_01_v8_graph_table_match.png', 'a': 8, 'left': 10, 'right': 10, 'point': 15, 'm1': 0.5, 'm2': -0.3}, {'kind': 'piecewise', 'filename': 'u1_sum_v1_q04_summative_limit_graph.png', 'a': 2, 'left': 3, 'right': 3, 'point': 8, 'm1': 0.5, 'm2': -0.4}, {'kind': 'piecewise', 'filename': 'u1_sum_v2_q04_summative_limit_graph.png', 'a': 3, 'left': 4, 'right': 7, 'point': 9, 'm1': 0.5, 'm2': -0.4}, {'kind': 'piecewise', 'filename': 'u1_sum_v3_q04_summative_limit_graph.png', 'a': 4, 'left': 5, 'right': 5, 'point': 10, 'm1': 0.5, 'm2': -0.4}, {'kind': 'piecewise', 'filename': 'u1_sum_v4_q04_summative_limit_graph.png', 'a': 5, 'left': 6, 'right': 9, 'point': 11, 'm1': 0.5, 'm2': -0.4}, {'kind': 'piecewise', 'filename': 'u1_sum_v5_q04_summative_limit_graph.png', 'a': 6, 'left': 7, 'right': 7, 'point': 12, 'm1': 0.5, 'm2': -0.4}, {'kind': 'piecewise', 'filename': 'u1_sum_v6_q04_summative_limit_graph.png', 'a': 7, 'left': 8, 'right': 11, 'point': 13, 'm1': 0.5, 'm2': -0.4}, {'kind': 'piecewise', 'filename': 'u1_sum_v7_q04_summative_limit_graph.png', 'a': 8, 'left': 9, 'right': 9, 'point': 14, 'm1': 0.5, 'm2': -0.4}, {'kind': 'piecewise', 'filename': 'u1_sum_v8_q04_summative_limit_graph.png', 'a': 9, 'left': 10, 'right': 13, 'point': 15, 'm1': 0.5, 'm2': -0.4}]

for spec in GRAPH_SPECS:
    kind = spec['kind']
    if kind == 'piecewise':
        a=spec['a']; left=spec['left']; right=spec['right']; m1=spec['m1']; m2=spec['m2']
        pieces=[
          {'expr':lambda x,a=a,left=left,m1=m1: left+m1*(x-a), 'deriv':lambda x,m1=m1: np.full_like(x,m1,dtype=float), 'domain':(-10,a), 'include_left':True, 'include_right':False, 'arrow_left':True},
          {'expr':lambda x,a=a,right=right,m2=m2: right+m2*(x-a), 'deriv':lambda x,m2=m2: np.full_like(x,m2,dtype=float), 'domain':(a,10), 'include_left':False, 'include_right':True, 'arrow_right':True}
        ]
        if spec.get('point') is not None:
            point=spec['point']
            pieces.append({'expr':lambda x,point=point: np.full_like(x,point,dtype=float), 'deriv':lambda x: np.zeros_like(x,dtype=float), 'domain':(a,a), 'include_left':True, 'include_right':True})
        fig,ax=plt.subplots(figsize=(3.5,3.5))
        make_piecewise_graph(ax,pieces,title='')
        save_graph(fig,spec['filename'])
        plt.close(fig)
    elif kind == 'rational':
        a=spec['a']; h=spec['h']; scale=spec['scale']
        functions=[{'expr':lambda x,a=a,h=h,scale=scale: scale/(x-a)+h, 'deriv':lambda x,a=a,scale=scale: -scale/(x-a)**2, 'color':'steelblue', 'label':None}]
        fig,ax=plt.subplots(figsize=(3.5,3.5))
        ...
        functions=[{'expr':lambda x,vx=vx,vy=vy: 0.15*(x-vx)**2+2.3*(x-vx)+vy, 'deriv':lambda x,vx=vx: 0.3*(x-vx)+2.3, 'color':'steelblue', 'label':None}]
        fig,ax=plt.subplots(figsize=(3.5,3.5))
        make_standard_graph(ax,functions,title='')
        save_graph(fig,spec['filename'])
        plt.close(fig)
