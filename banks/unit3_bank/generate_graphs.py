...
# ============================================================================
# UNIT 3 BANK GENERATED FIGURES - APPENDED BELOW FINAL APPROVED MARKER
# ============================================================================

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: (1.0)*x**3+(2), 'deriv': lambda x: 3*(1.0)*x**2, 'color': 'steelblue', 'label': 'f'},
    {'expr': lambda x: np.cbrt((x-(2))/(1.0)), 'deriv': lambda x: 1.0/(3.0*(1.0)*np.maximum(np.abs(np.cbrt((x-(2))/(1.0))),1e-4)**2), 'color': 'firebrick', 'label': 'g'}
], title='')
save_graph(fig, 'u3_fa_d3_03_v1_formative_inverse.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: (2.0)*x**3+(3), 'deriv': lambda x: 3*(2.0)*x**2, 'color': 'steelblue', 'label': 'f'},
    {'expr': lambda x: np.cbrt((x-(3))/(2.0)), 'deriv': lambda x: 1.0/(3.0*(2.0)*np.maximum(np.abs(np.cbrt((x-(3))/(2.0))),1e-4)**2), 'color': 'firebrick', 'label': 'g'}
], title='')
save_graph(fig, 'u3_fa_d3_03_v2_formative_inverse.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: (0.5)*x**3+(-1), 'deriv': lambda x: 3*(0.5)*x**2, 'color': 'steelblue', 'label': 'f'},
    {'expr': lambda x: np.cbrt((x-(-1))/(0.5)), 'deriv': lambda x: 1.0/(3.0*(0.5)*np.maximum(np.abs(np.cbrt((x-(-1))/(0.5))),1e-4)**2), 'color': 'firebrick', 'label': 'g'}
], title='')
save_graph(fig, 'u3_fa_d3_03_v3_formative_inverse.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: (2.0)*x**3+(-1), 'deriv': lambda x: 3*(2.0)*x**2, 'color': 'steelblue', 'label': 'f'},
    {'expr': lambda x: np.cbrt((x-(-1))/(2.0)), 'deriv': lambda x: 1.0/(3.0*(2.0)*np.maximum(np.abs(np.cbrt((x-(-1))/(2.0))),1e-4)**2), 'color': 'firebrick', 'label': 'g'}
], title='')
save_graph(fig, 'u3_fa_d3_03_v4_formative_inverse.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: (2.0)*x**3+(2), 'deriv': lambda x: 3*(2.0)*x**2, 'color': 'steelblue', 'label': 'f'},
    {'expr': lambda x: np.cbrt((x-(2))/(2.0)), 'deriv': lambda x: 1.0/(3.0*(2.0)*np.maximum(np.abs(np.cbrt((x-(2))/(2.0))),1e-4)**2), 'color': 'firebrick', 'label': 'g'}
], title='')
save_graph(fig, 'u3_fa_d3_03_v5_formative_inverse.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: (2.0)*x**3+(-0.65), 'deriv': lambda x: 3*(2.0)*x**2, 'color': 'steelblue', 'label': 'f'},
    {'expr': lambda x: np.cbrt((x-(-0.65))/(2.0)), 'deriv': lambda x: 1.0/(3.0*(2.0)*np.maximum(np.abs(np.cbrt((x-(-0.65))/(2.0))),1e-4)**2), 'color': 'firebrick', 'label': 'g'}
], title='')
save_graph(fig, 'u3_fa_d3_03_v6_formative_inverse.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: (1.0)*x**3+(-1.2999999999999998), 'deriv': lambda x: 3*(1.0)*x**2, 'color': 'steelblue', 'label': 'f'},
    {'expr': lambda x: np.cbrt((x-(-1.2999999999999998))/(1.0)), 'deriv': lambda x: 1.0/(3.0*(1.0)*np.maximum(np.abs(np.cbrt((x-(-1.2999999999999998))/(1.0))),1e-4)**2), 'color': 'firebrick', 'label': 'g'}
], title='')
save_graph(fig, 'u3_fa_d3_03_v7_formative_inverse.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: (2.0)*x**3+(2.35), 'deriv': lambda x: 3*(2.0)*x**2, 'color': 'steelblue', 'label': 'f'},
    {'expr': lambda x: np.cbrt((x-(2.35))/(2.0)), 'deriv': lambda x: 1.0/(3.0*(2.0)*np.maximum(np.abs(np.cbrt((x-(2.35))/(2.0))),1e-4)**2), 'color': 'firebrick', 'label': 'g'}
], title='')
save_graph(fig, 'u3_fa_d3_03_v8_formative_inverse.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: (2.0)*x**3+(2.7), 'deriv': lambda x: 3*(2.0)*x**2, 'color': 'steelblue', 'label': 'f'},
    {'expr': lambda x: np.cbrt((x-(2.7))/(2.0)), 'deriv': lambda x: 1.0/(3.0*(2.0)*np.maximum(np.abs(np.cbrt((x-(2.7))/(2.0))),1e-4)**2), 'color': 'firebrick', 'label': 'g'}
], title='')
save_graph(fig, 'u3_fa_d4_03_v1_formative_inverse_model.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: (0.5)*x**3+(-3), 'deriv': lambda x: 3*(0.5)*x**2, 'color': 'steelblue', 'label': 'f'},
    {'expr': lambda x: np.cbrt((x-(-3))/(0.5)), 'deriv': lambda x: 1.0/(3.0*(0.5)*np.maximum(np.abs(np.cbrt((x-(-3))/(0.5))),1e-4)**2), 'color': 'firebrick', 'label': 'g'}
], title='')
save_graph(fig, 'u3_fa_d4_03_v2_formative_inverse_model.png')
plt.close(fig)
...
save_graph(fig, 'u3_fa_d4_03_v3_formative_inverse_model.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: (1.0)*x**3+(-0.9499999999999998), 'deriv': lambda x: 3*(1.0)*x**2, 'color': 'steelblue', 'label': 'f'},
    {'expr': lambda x: np.cbrt((x-(-0.9499999999999998))/(1.0)), 'deriv': lambda x: 1.0/(3.0*(1.0)*np.maximum(np.abs(np.cbrt((x-(-0.9499999999999998))/(1.0))),1e-4)**2), 'color': 'firebrick', 'label': 'g'}
], title='')
save_graph(fig, 'u3_fa_d4_03_v4_formative_inverse_model.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: (0.5)*x**3+(-2.65), 'deriv': lambda x: 3*(0.5)*x**2, 'color': 'steelblue', 'label': 'f'},
    {'expr': lambda x: np.cbrt((x-(-2.65))/(0.5)), 'deriv': lambda x: 1.0/(3.0*(0.5)*np.maximum(np.abs(np.cbrt((x-(-2.65))/(0.5))),1e-4)**2), 'color': 'firebrick', 'label': 'g'}
], title='')
save_graph(fig, 'u3_fa_d4_03_v5_formative_inverse_model.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: (1.0)*x**3+(-1), 'deriv': lambda x: 3*(1.0)*x**2, 'color': 'steelblue', 'label': 'f'},
    {'expr': lambda x: np.cbrt((x-(-1))/(1.0)), 'deriv': lambda x: 1.0/(3.0*(1.0)*np.maximum(np.abs(np.cbrt((x-(-1))/(1.0))),1e-4)**2), 'color': 'firebrick', 'label': 'g'}
], title='')
save_graph(fig, 'u3_fa_d4_03_v6_formative_inverse_model.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: (1.0)*x**3+(-0.5999999999999999), 'deriv': lambda x: 3*(1.0)*x**2, 'color': 'steelblue', 'label': 'f'},
    {'expr': lambda x: np.cbrt((x-(-0.5999999999999999))/(1.0)), 'deriv': lambda x: 1.0/(3.0*(1.0)*np.maximum(np.abs(np.cbrt((x-(-0.5999999999999999))/(1.0))),1e-4)**2), 'color': 'firebrick', 'label': 'g'}
], title='')
save_graph(fig, 'u3_fa_d4_03_v7_formative_inverse_model.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: (1.0)*x**3+(2.35), 'deriv': lambda x: 3*(1.0)*x**2, 'color': 'steelblue', 'label': 'f'},
    {'expr': lambda x: np.cbrt((x-(2.35))/(1.0)), 'deriv': lambda x: 1.0/(3.0*(1.0)*np.maximum(np.abs(np.cbrt((x-(2.35))/(1.0))),1e-4)**2), 'color': 'firebrick', 'label': 'g'}
], title='')
save_graph(fig, 'u3_fa_d4_03_v8_formative_inverse_model.png')
plt.close(fig)
...
save_graph(fig, 'u3_s4_cyu_c02_inverse_pair.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: (1.0)*x**3+(3.35), 'deriv': lambda x: 3*(1.0)*x**2, 'color': 'steelblue', 'label': 'f'},
    {'expr': lambda x: np.cbrt((x-(3.35))/(1.0)), 'deriv': lambda x: 1.0/(3.0*(1.0)*np.maximum(np.abs(np.cbrt((x-(3.35))/(1.0))),1e-4)**2), 'color': 'firebrick', 'label': 'g'}
], title='')
save_graph(fig, 'u3_s4_et_a_c01_inverse_pair.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: (2.0)*x**3+(1.35), 'deriv': lambda x: 3*(2.0)*x**2, 'color': 'steelblue', 'label': 'f'},
    {'expr': lambda x: np.cbrt((x-(1.35))/(2.0)), 'deriv': lambda x: 1.0/(3.0*(2.0)*np.maximum(np.abs(np.cbrt((x-(1.35))/(2.0))),1e-4)**2), 'color': 'firebrick', 'label': 'g'}
], title='')
save_graph(fig, 'u3_s4_perf01_inverse_model.png')
plt.close(fig)
...
save_graph(fig, 'u3_s4_ps1_c05_inverse_pair.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: (0.5)*x**3+(2), 'deriv': lambda x: 3*(0.5)*x**2, 'color': 'steelblue', 'label': 'f'},
    {'expr': lambda x: np.cbrt((x-(2))/(0.5)), 'deriv': lambda x: 1.0/(3.0*(0.5)*np.maximum(np.abs(np.cbrt((x-(2))/(0.5))),1e-4)**2), 'color': 'firebrick', 'label': 'g'}
], title='')
save_graph(fig, 'u3_s4_ps2_c03_inverse_pair.png')
plt.close(fig)
...
save_graph(fig, 'u3_s4_xp_c05_inverse_pair.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: (1.0)*x**3+(3), 'deriv': lambda x: 3*(1.0)*x**2, 'color': 'steelblue', 'label': 'f'},
    {'expr': lambda x: np.cbrt((x-(3))/(1.0)), 'deriv': lambda x: 1.0/(3.0*(1.0)*np.maximum(np.abs(np.cbrt((x-(3))/(1.0))),1e-4)**2), 'color': 'firebrick', 'label': 'g'}
], title='')
save_graph(fig, 'u3_s5_ps2_l04_inverse_pair.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: (1.0)*x**3+(-1.65), 'deriv': lambda x: 3*(1.0)*x**2, 'color': 'steelblue', 'label': 'f'},
    {'expr': lambda x: np.cbrt((x-(-1.65))/(1.0)), 'deriv': lambda x: 1.0/(3.0*(1.0)*np.maximum(np.abs(np.cbrt((x-(-1.65))/(1.0))),1e-4)**2), 'color': 'firebrick', 'label': 'g'}
], title='')
save_graph(fig, 'u3_s5_wu2_l01_inverse_pair.png')
plt.close(fig)
