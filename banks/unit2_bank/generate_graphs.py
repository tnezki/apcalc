...
# ============================================================================
# UNIT 2 BANK GENERATED FIGURES - APPENDED BELOW FINAL APPROVED MARKER
# ============================================================================

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_piecewise_graph(ax, [
    {'expr': lambda x, m=1, b=2: m*x+b, 'deriv': lambda x, m=1: np.zeros_like(x,dtype=float)+m, 'domain': (-8,-1), 'include_left': True, 'include_right': False, 'arrow_left': True, 'arrow_right': False},
    {'expr': lambda x, m=-0.5, b=2.5: m*x+b, 'deriv': lambda x, m=-0.5: np.zeros_like(x,dtype=float)+m, 'domain': (-1,8), 'include_left': True, 'include_right': True, 'arrow_left': False, 'arrow_right': True}
], title='')
save_graph(fig, 'u2_fa_d1_03_v1_formative_feature.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.abs(x-(0))+(1), 'deriv': lambda x: np.where(x<(0),-1.0,1.0), 'color': 'steelblue', 'label': 'f'}
], title='')
save_graph(fig, 'u2_fa_d1_03_v2_formative_feature.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.power(np.abs(x-(-3)),2.0/3.0)+(2), 'deriv': lambda x: (2.0/3.0)*np.sign(x-(-3))*np.power(np.maximum(np.abs(x-(-3)),1e-6),-1.0/3.0), 'color': 'steelblue', 'label': 'f'}
], title='')
save_graph(fig, 'u2_fa_d1_03_v3_formative_feature.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.power(np.abs(x-(2)),2.0/3.0)+(0), 'deriv': lambda x: (2.0/3.0)*np.sign(x-(2))*np.power(np.maximum(np.abs(x-(2)),1e-6),-1.0/3.0), 'color': 'steelblue', 'label': 'f'}
], title='')
save_graph(fig, 'u2_fa_d1_03_v4_formative_feature.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.cbrt(x-(2))+(1), 'deriv': lambda x: 1.0/(3.0*np.maximum(np.abs(np.cbrt(x-(2))),1e-4)**2), 'color': 'steelblue', 'label': 'f'}
], title='')
save_graph(fig, 'u2_fa_d1_03_v5_formative_feature.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_piecewise_graph(ax, [
    {'expr': lambda x, m=1, b=1: m*x+b, 'deriv': lambda x, m=1: np.zeros_like(x,dtype=float)+m, 'domain': (-8,1), 'include_left': True, 'include_right': False, 'arrow_left': True, 'arrow_right': False},
    {'expr': lambda x, m=-0.5, b=6.5: m*x+b, 'deriv': lambda x, m=-0.5: np.zeros_like(x,dtype=float)+m, 'domain': (1,8), 'include_left': True, 'include_right': True, 'arrow_left': False, 'arrow_right': True}
], title='')
save_graph(fig, 'u2_fa_d1_03_v6_formative_feature.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.cbrt(x-(1))+(2), 'deriv': lambda x: 1.0/(3.0*np.maximum(np.abs(np.cbrt(x-(1))),1e-4)**2), 'color': 'steelblue', 'label': 'f'}
], title='')
save_graph(fig, 'u2_fa_d1_03_v7_formative_feature.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.abs(x-(3))+(1), 'deriv': lambda x: np.where(x<(3),-1.0,1.0), 'color': 'steelblue', 'label': 'f'}
], title='')
save_graph(fig, 'u2_fa_d1_03_v8_formative_feature.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.power(np.abs(x-(1)),2.0/3.0)+(-1), 'deriv': lambda x: (2.0/3.0)*np.sign(x-(1))*np.power(np.maximum(np.abs(x-(1)),1e-6),-1.0/3.0), 'color': 'steelblue', 'label': 'f'}
], title='')
save_graph(fig, 'u2_fa_d2_03_v1_classification.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_piecewise_graph(ax, [
    {'expr': lambda x, m=1, b=1: m*x+b, 'deriv': lambda x, m=1: np.zeros_like(x,dtype=float)+m, 'domain': (-8,-4), 'include_left': True, 'include_right': False, 'arrow_left': True, 'arrow_right': False},
    {'expr': lambda x, m=-0.5, b=-1.0: m*x+b, 'deriv': lambda x, m=-0.5: np.zeros_like(x,dtype=float)+m, 'domain': (-4,8), 'include_left': True, 'include_right': True, 'arrow_left': False, 'arrow_right': True}
], title='')
save_graph(fig, 'u2_fa_d2_03_v3_classification.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.abs(x-(2))+(2), 'deriv': lambda x: np.where(x<(2),-1.0,1.0), 'color': 'steelblue', 'label': 'f'}
], title='')
save_graph(fig, 'u2_fa_d2_03_v5_classification.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.power(np.abs(x-(0)),2.0/3.0)+(2), 'deriv': lambda x: (2.0/3.0)*np.sign(x-(0))*np.power(np.maximum(np.abs(x-(0)),1e-6),-1.0/3.0), 'color': 'steelblue', 'label': 'f'}
], title='')
save_graph(fig, 'u2_fa_d2_03_v7_classification.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: (1.5)*x**2+(-3), 'deriv': lambda x: 2*(1.5)*x, 'color': 'steelblue', 'label': 'f'},
    {'expr': lambda x: (-6.0)*x+(-9.0), 'deriv': lambda x: np.zeros_like(x,dtype=float)+(-6.0), 'color': 'firebrick', 'label': 'L'}
], title='')
save_graph(fig, 'u2_s2_et_c_c01_tangent_evidence.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: (2.0)*x**2+(2), 'deriv': lambda x: 2*(2.0)*x, 'color': 'steelblue', 'label': 'f'},
    {'expr': lambda x: (-12.0)*x+(-16.0), 'deriv': lambda x: np.zeros_like(x,dtype=float)+(-12.0), 'color': 'firebrick', 'label': 'L'}
], title='')
save_graph(fig, 'u2_s2_ps1_c05_tangent_evidence.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: (2.0)*x**2+(-1), 'deriv': lambda x: 2*(2.0)*x, 'color': 'steelblue', 'label': 'f'},
    {'expr': lambda x: (12.0)*x+(-19.0), 'deriv': lambda x: np.zeros_like(x,dtype=float)+(12.0), 'color': 'firebrick', 'label': 'L'}
], title='')
save_graph(fig, 'u2_s2_ps2_c05_tangent_evidence.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: (2.0)*x**2+(3), 'deriv': lambda x: 2*(2.0)*x, 'color': 'steelblue', 'label': 'f'},
    {'expr': lambda x: (-4.0)*x+(1.0), 'deriv': lambda x: np.zeros_like(x,dtype=float)+(-4.0), 'color': 'firebrick', 'label': 'L'}
], title='')
save_graph(fig, 'u2_s2_xp_c05_tangent_evidence.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.abs(x-(3))+(4), 'deriv': lambda x: np.where(x<(3),-1.0,1.0), 'color': 'steelblue', 'label': 'f'}
], title='')
save_graph(fig, 'u2_s3_et_a_c01_feature.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: (2.0)*x**2+(1), 'deriv': lambda x: 2*(2.0)*x, 'color': 'steelblue', 'label': 'f'},
    {'expr': lambda x: (8.0)*x+(-7.0), 'deriv': lambda x: np.zeros_like(x,dtype=float)+(8.0), 'color': 'firebrick', 'label': 'L'}
], title='')
save_graph(fig, 'u2_s3_et_b_l01_tangent_evidence.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.cbrt(x-(-3))+(-1), 'deriv': lambda x: 1.0/(3.0*np.maximum(np.abs(np.cbrt(x-(-3))),1e-4)**2), 'color': 'steelblue', 'label': 'f'}
], title='')
save_graph(fig, 'u2_s3_et_c_c02_feature.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.power(np.abs(x-(3)),2.0/3.0)+(1), 'deriv': lambda x: (2.0/3.0)*np.sign(x-(3))*np.power(np.maximum(np.abs(x-(3)),1e-6),-1.0/3.0), 'color': 'steelblue', 'label': 'f'}
], title='')
save_graph(fig, 'u2_s3_note_ex01_feature.png')
plt.close(fig)
...
save_graph(fig, 'u2_s3_note_yti01_feature.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.cbrt(x-(2))+(0), 'deriv': lambda x: 1.0/(3.0*np.maximum(np.abs(np.cbrt(x-(2))),1e-4)**2), 'color': 'steelblue', 'label': 'f'}
], title='')
save_graph(fig, 'u2_s3_ps1_c01_feature.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: (2.0)*x**2+(-4), 'deriv': lambda x: 2*(2.0)*x, 'color': 'steelblue', 'label': 'f'},
    {'expr': lambda x: (-4.0)*x+(-6.0), 'deriv': lambda x: np.zeros_like(x,dtype=float)+(-4.0), 'color': 'firebrick', 'label': 'L'}
], title='')
save_graph(fig, 'u2_s3_ps1_l05_tangent_evidence.png')
plt.close(fig)
...
save_graph(fig, 'u2_s3_ps2_c01_feature.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: (1.5)*x**2+(-1), 'deriv': lambda x: 2*(1.5)*x, 'color': 'steelblue', 'label': 'f'},
    {'expr': lambda x: (-9.0)*x+(-14.5), 'deriv': lambda x: np.zeros_like(x,dtype=float)+(-9.0), 'color': 'firebrick', 'label': 'L'}
], title='')
save_graph(fig, 'u2_s3_ps2_l05_tangent_evidence.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_piecewise_graph(ax, [
    {'expr': lambda x, m=1, b=-2: m*x+b, 'deriv': lambda x, m=1: np.zeros_like(x,dtype=float)+m, 'domain': (-8,-2), 'include_left': True, 'include_right': False, 'arrow_left': True, 'arrow_right': False},
    {'expr': lambda x, m=-0.5, b=-3.0: m*x+b, 'deriv': lambda x, m=-0.5: np.zeros_like(x,dtype=float)+m, 'domain': (-2,8), 'include_left': True, 'include_right': True, 'arrow_left': False, 'arrow_right': True}
], title='')
save_graph(fig, 'u2_s3_xp_c01_feature.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: (1.5)*x**2+(2), 'deriv': lambda x: 2*(1.5)*x, 'color': 'steelblue', 'label': 'f'},
    {'expr': lambda x: (9.0)*x+(-11.5), 'deriv': lambda x: np.zeros_like(x,dtype=float)+(9.0), 'color': 'firebrick', 'label': 'L'}
], title='')
save_graph(fig, 'u2_s3_xp_l05_tangent_evidence.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_piecewise_graph(ax, [
    {'expr': lambda x, m=1, b=-2: m*x+b, 'deriv': lambda x, m=1: np.zeros_like(x,dtype=float)+m, 'domain': (-8,-3), 'include_left': True, 'include_right': False, 'arrow_left': True, 'arrow_right': False},
    {'expr': lambda x, m=-0.5, b=-3.5: m*x+b, 'deriv': lambda x, m=-0.5: np.zeros_like(x,dtype=float)+m, 'domain': (-3,8), 'include_left': True, 'include_right': True, 'arrow_left': False, 'arrow_right': True}
], title='')
save_graph(fig, 'u2_s4_ps1_l01_feature.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.power(np.abs(x-(-1)),2.0/3.0)+(-3), 'deriv': lambda x: (2.0/3.0)*np.sign(x-(-1))*np.power(np.maximum(np.abs(x-(-1)),1e-6),-1.0/3.0), 'color': 'steelblue', 'label': 'f'}
], title='')
save_graph(fig, 'u2_s4_ps2_l01_feature.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_piecewise_graph(ax, [
    {'expr': lambda x, m=1, b=1: m*x+b, 'deriv': lambda x, m=1: np.zeros_like(x,dtype=float)+m, 'domain': (-8,2), 'include_left': True, 'include_right': False, 'arrow_left': True, 'arrow_right': False},
    {'expr': lambda x, m=-0.5, b=8.0: m*x+b, 'deriv': lambda x, m=-0.5: np.zeros_like(x,dtype=float)+m, 'domain': (2,8), 'include_left': True, 'include_right': True, 'arrow_left': False, 'arrow_right': True}
], title='')
save_graph(fig, 'u2_s4_xp_l01_feature.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.cbrt(x-(-2))+(-3), 'deriv': lambda x: 1.0/(3.0*np.maximum(np.abs(np.cbrt(x-(-2))),1e-4)**2), 'color': 'steelblue', 'label': 'f'}
], title='')
save_graph(fig, 'u2_sum_v1_q09_summative_feature.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.power(np.abs(x-(0)),2.0/3.0)+(1), 'deriv': lambda x: (2.0/3.0)*np.sign(x-(0))*np.power(np.maximum(np.abs(x-(0)),1e-6),-1.0/3.0), 'color': 'steelblue', 'label': 'f'}
], title='')
save_graph(fig, 'u2_sum_v2_q09_summative_feature.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_piecewise_graph(ax, [
    {'expr': lambda x, m=1, b=1: m*x+b, 'deriv': lambda x, m=1: np.zeros_like(x,dtype=float)+m, 'domain': (-8,-2), 'include_left': True, 'include_right': False, 'arrow_left': True, 'arrow_right': False},
    {'expr': lambda x, m=-0.5, b=2.0: m*x+b, 'deriv': lambda x, m=-0.5: np.zeros_like(x,dtype=float)+m, 'domain': (-2,8), 'include_left': True, 'include_right': True, 'arrow_left': False, 'arrow_right': True}
], title='')
save_graph(fig, 'u2_sum_v3_q09_summative_feature.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.abs(x-(-2))+(-4), 'deriv': lambda x: np.where(x<(-2),-1.0,1.0), 'color': 'steelblue', 'label': 'f'}
], title='')
save_graph(fig, 'u2_sum_v4_q09_summative_feature.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.power(np.abs(x-(2)),2.0/3.0)+(2), 'deriv': lambda x: (2.0/3.0)*np.sign(x-(2))*np.power(np.maximum(np.abs(x-(2)),1e-6),-1.0/3.0), 'color': 'steelblue', 'label': 'f'}
], title='')
save_graph(fig, 'u2_sum_v5_q09_summative_feature.png')
plt.close(fig)
...
save_graph(fig, 'u2_sum_v6_q09_summative_feature.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_piecewise_graph(ax, [
    {'expr': lambda x, m=1, b=1: m*x+b, 'deriv': lambda x, m=1: np.zeros_like(x,dtype=float)+m, 'domain': (-8,4), 'include_left': True, 'include_right': False, 'arrow_left': True, 'arrow_right': False},
    {'expr': lambda x, m=-0.5, b=11.0: m*x+b, 'deriv': lambda x, m=-0.5: np.zeros_like(x,dtype=float)+m, 'domain': (4,8), 'include_left': True, 'include_right': True, 'arrow_left': False, 'arrow_right': True}
], title='')
save_graph(fig, 'u2_sum_v7_q09_summative_feature.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.cbrt(x-(4))+(3), 'deriv': lambda x: 1.0/(3.0*np.maximum(np.abs(np.cbrt(x-(4))),1e-4)**2), 'color': 'steelblue', 'label': 'f'}
], title='')
save_graph(fig, 'u2_sum_v8_q09_summative_feature.png')
plt.close(fig)
