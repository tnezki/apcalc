...
# ============================================================================
# UNIT 6 BANK GENERATED FIGURES - APPENDED BELOW FINAL APPROVED MARKER
# ============================================================================

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([-0.3, 0.29999999999999993, 1.8097199999999998], x), 'deriv': lambda x: np.polyval([-0.6, 0.29999999999999993], x), 'color': 'steelblue', 'label': 'f'}
], title='')
save_graph(fig, 'u6_fa_d2_02_v1_fa_integrand.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([-0.2, 1.0, -0.79305], x), 'deriv': lambda x: np.polyval([-0.4, 1.0], x), 'color': 'steelblue', 'label': 'f'}
], title='')
save_graph(fig, 'u6_fa_d2_02_v3_fa_integrand.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([-0.3, -1.5, -1.19449], x), 'deriv': lambda x: np.polyval([-0.6, -1.5], x), 'color': 'steelblue', 'label': 'f'}
], title='')
save_graph(fig, 'u6_fa_d2_02_v5_fa_integrand.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([0.2, -0.4000000000000001, -0.59345], x), 'deriv': lambda x: np.polyval([0.4, -0.4000000000000001], x), 'color': 'steelblue', 'label': 'f'}
], title='')
save_graph(fig, 'u6_fa_d2_02_v7_fa_integrand.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([-0.08, 0.16, 0.4, -0.47836999999999996], x), 'deriv': lambda x: np.polyval([-0.24, 0.32, 0.4], x), 'color': 'steelblue', 'label': 'f'}
], title='')
save_graph(fig, 'u6_fa_d3_02_v1_fa_synthesis.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([-0.08, 0.16, 1.28, -2.55131], x), 'deriv': lambda x: np.polyval([-0.24, 0.32, 1.28], x), 'color': 'steelblue', 'label': 'f'}
], title='')
save_graph(fig, 'u6_fa_d3_02_v2_fa_synthesis.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([0.08, -0.08, -0.8, -0.63307], x), 'deriv': lambda x: np.polyval([0.24, -0.16, -0.8], x), 'color': 'steelblue', 'label': 'f'}
], title='')
save_graph(fig, 'u6_fa_d3_02_v3_fa_synthesis.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([0.08, -0.24, -0.48, 0.64325], x), 'deriv': lambda x: np.polyval([0.24, -0.48, -0.48], x), 'color': 'steelblue', 'label': 'f'}
], title='')
save_graph(fig, 'u6_fa_d3_02_v4_fa_synthesis.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([-0.08, 0.32, 0.08, -0.31901], x), 'deriv': lambda x: np.polyval([-0.24, 0.64, 0.08], x), 'color': 'steelblue', 'label': 'f'}
], title='')
save_graph(fig, 'u6_fa_d3_02_v5_fa_synthesis.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([0.08, -0.08, -1.28, 1.28574], x), 'deriv': lambda x: np.polyval([0.24, -0.16, -1.28], x), 'color': 'steelblue', 'label': 'f'}
], title='')
save_graph(fig, 'u6_fa_d3_02_v6_fa_synthesis.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([-0.06, 0.12, 0.06, -0.11589999999999999], x), 'deriv': lambda x: np.polyval([-0.18, 0.24, 0.06], x), 'color': 'steelblue', 'label': 'f'}
], title='')
save_graph(fig, 'u6_fa_d3_02_v7_fa_synthesis.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([0.06, -0.36, 0.6599999999999999, -0.35719], x), 'deriv': lambda x: np.polyval([0.18, -0.72, 0.6599999999999999], x), 'color': 'steelblue', 'label': 'f'}
], title='')
save_graph(fig, 'u6_fa_d3_02_v8_fa_synthesis.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_piecewise_graph(ax, [
    {'expr': lambda x, m=-3.0, b=3.0: m*x+b, 'deriv': lambda x, m=-3.0: np.zeros_like(x,dtype=float)+m, 'domain': (0,2), 'include_left': True, 'include_right': False, 'arrow_left': False, 'arrow_right': False},
    {'expr': lambda x, m=-0.5, b=-2.0: m*x+b, 'deriv': lambda x, m=-0.5: np.zeros_like(x,dtype=float)+m, 'domain': (2,4), 'include_left': True, 'include_right': False, 'arrow_left': False, 'arrow_right': False},
    {'expr': lambda x, m=2.5, b=-14.0: m*x+b, 'deriv': lambda x, m=2.5: np.zeros_like(x,dtype=float)+m, 'domain': (4,6), 'include_left': True, 'include_right': True, 'arrow_left': False, 'arrow_right': False}
], title='')
save_graph(fig, 'u6_s1_et_b_c02_rate_graph.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_piecewise_graph(ax, [
    {'expr': lambda x, m=-4.5, b=4.0: m*x+b, 'deriv': lambda x, m=-4.5: np.zeros_like(x,dtype=float)+m, 'domain': (0,2), 'include_left': True, 'include_right': False, 'arrow_left': False, 'arrow_right': False},
    {'expr': lambda x, m=1.5, b=-8.0: m*x+b, 'deriv': lambda x, m=1.5: np.zeros_like(x,dtype=float)+m, 'domain': (2,4), 'include_left': True, 'include_right': False, 'arrow_left': False, 'arrow_right': False},
    {'expr': lambda x, m=0.5, b=-4.0: m*x+b, 'deriv': lambda x, m=0.5: np.zeros_like(x,dtype=float)+m, 'domain': (4,6), 'include_left': True, 'include_right': True, 'arrow_left': False, 'arrow_right': False}
], title='')
save_graph(fig, 'u6_s1_et_c_c01_rate_graph.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_piecewise_graph(ax, [
    {'expr': lambda x, m=-3.5, b=2.0: m*x+b, 'deriv': lambda x, m=-3.5: np.zeros_like(x,dtype=float)+m, 'domain': (0,2), 'include_left': True, 'include_right': False, 'arrow_left': False, 'arrow_right': False},
    {'expr': lambda x, m=3.5, b=-12.0: m*x+b, 'deriv': lambda x, m=3.5: np.zeros_like(x,dtype=float)+m, 'domain': (2,4), 'include_left': True, 'include_right': False, 'arrow_left': False, 'arrow_right': False},
    {'expr': lambda x, m=-1.5, b=8.0: m*x+b, 'deriv': lambda x, m=-1.5: np.zeros_like(x,dtype=float)+m, 'domain': (4,6), 'include_left': True, 'include_right': True, 'arrow_left': False, 'arrow_right': False}
], title='')
save_graph(fig, 'u6_s1_note_ex01_rate_graph.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_piecewise_graph(ax, [
    {'expr': lambda x, m=0.5, b=-4.0: m*x+b, 'deriv': lambda x, m=0.5: np.zeros_like(x,dtype=float)+m, 'domain': (0,2), 'include_left': True, 'include_right': False, 'arrow_left': False, 'arrow_right': False},
    {'expr': lambda x, m=2.5, b=-8.0: m*x+b, 'deriv': lambda x, m=2.5: np.zeros_like(x,dtype=float)+m, 'domain': (2,4), 'include_left': True, 'include_right': False, 'arrow_left': False, 'arrow_right': False},
    {'expr': lambda x, m=-2.5, b=12.0: m*x+b, 'deriv': lambda x, m=-2.5: np.zeros_like(x,dtype=float)+m, 'domain': (4,6), 'include_left': True, 'include_right': True, 'arrow_left': False, 'arrow_right': False}
], title='')
save_graph(fig, 'u6_s1_ps2_c05_rate_graph.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_piecewise_graph(ax, [
    {'expr': lambda x, m=4.0, b=-3.0: m*x+b, 'deriv': lambda x, m=4.0: np.zeros_like(x,dtype=float)+m, 'domain': (0,2), 'include_left': True, 'include_right': False, 'arrow_left': False, 'arrow_right': False},
    {'expr': lambda x, m=-0.5, b=6.0: m*x+b, 'deriv': lambda x, m=-0.5: np.zeros_like(x,dtype=float)+m, 'domain': (2,4), 'include_left': True, 'include_right': False, 'arrow_left': False, 'arrow_right': False},
    {'expr': lambda x, m=-0.5, b=6.0: m*x+b, 'deriv': lambda x, m=-0.5: np.zeros_like(x,dtype=float)+m, 'domain': (4,6), 'include_left': True, 'include_right': True, 'arrow_left': False, 'arrow_right': False}
], title='')
save_graph(fig, 'u6_s1_xp_c03_rate_graph.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_piecewise_graph(ax, [
    {'expr': lambda x, m=-2.5, b=4.0: m*x+b, 'deriv': lambda x, m=-2.5: np.zeros_like(x,dtype=float)+m, 'domain': (0,2), 'include_left': True, 'include_right': False, 'arrow_left': False, 'arrow_right': False},
    {'expr': lambda x, m=-0.5, b=0.0: m*x+b, 'deriv': lambda x, m=-0.5: np.zeros_like(x,dtype=float)+m, 'domain': (2,4), 'include_left': True, 'include_right': False, 'arrow_left': False, 'arrow_right': False},
    {'expr': lambda x, m=2.5, b=-12.0: m*x+b, 'deriv': lambda x, m=2.5: np.zeros_like(x,dtype=float)+m, 'domain': (4,6), 'include_left': True, 'include_right': True, 'arrow_left': False, 'arrow_right': False}
], title='')
save_graph(fig, 'u6_s2_cyu_l02_rate_graph.png')
plt.close(fig)
...
save_graph(fig, 'u6_s2_et_a_l01_rate_graph.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_piecewise_graph(ax, [
    {'expr': lambda x, m=-0.5, b=4.0: m*x+b, 'deriv': lambda x, m=-0.5: np.zeros_like(x,dtype=float)+m, 'domain': (0,2), 'include_left': True, 'include_right': False, 'arrow_left': False, 'arrow_right': False},
    {'expr': lambda x, m=-0.5, b=4.0: m*x+b, 'deriv': lambda x, m=-0.5: np.zeros_like(x,dtype=float)+m, 'domain': (2,4), 'include_left': True, 'include_right': False, 'arrow_left': False, 'arrow_right': False},
    {'expr': lambda x, m=-1.5, b=8.0: m*x+b, 'deriv': lambda x, m=-1.5: np.zeros_like(x,dtype=float)+m, 'domain': (4,6), 'include_left': True, 'include_right': True, 'arrow_left': False, 'arrow_right': False}
], title='')
save_graph(fig, 'u6_s2_ps1_l03_rate_graph.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_piecewise_graph(ax, [
    {'expr': lambda x, m=1.0, b=3.0: m*x+b, 'deriv': lambda x, m=1.0: np.zeros_like(x,dtype=float)+m, 'domain': (0,2), 'include_left': True, 'include_right': False, 'arrow_left': False, 'arrow_right': False},
    {'expr': lambda x, m=-1.5, b=8.0: m*x+b, 'deriv': lambda x, m=-1.5: np.zeros_like(x,dtype=float)+m, 'domain': (2,4), 'include_left': True, 'include_right': False, 'arrow_left': False, 'arrow_right': False},
    {'expr': lambda x, m=-1.5, b=8.0: m*x+b, 'deriv': lambda x, m=-1.5: np.zeros_like(x,dtype=float)+m, 'domain': (4,6), 'include_left': True, 'include_right': True, 'arrow_left': False, 'arrow_right': False}
], title='')
save_graph(fig, 'u6_s2_ps2_l02_rate_graph.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([0.2, -0.4000000000000001, -0.5935000000000001], x), 'deriv': lambda x: np.polyval([0.4, -0.4000000000000001], x), 'color': 'steelblue', 'label': 'f'}
], title='')
save_graph(fig, 'u6_s3_cyu_c01_integrand.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([-0.3, -0.30000000000000004, 3.6049599999999997], x), 'deriv': lambda x: np.polyval([-0.6, -0.30000000000000004], x), 'color': 'steelblue', 'label': 'f'}
], title='')
save_graph(fig, 'u6_s3_et_c_c02_integrand.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([0.2, -1.2000000000000002, 1.60091], x), 'deriv': lambda x: np.polyval([0.4, -1.2000000000000002], x), 'color': 'steelblue', 'label': 'f'}
], title='')
save_graph(fig, 'u6_s3_note_ex02_integrand.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([0.2, 0.4, -1.59908], x), 'deriv': lambda x: np.polyval([0.4, 0.4], x), 'color': 'steelblue', 'label': 'f'}
], title='')
save_graph(fig, 'u6_s3_note_yti01_integrand.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([0.2, -0.19999999999999996, -2.3911000000000002], x), 'deriv': lambda x: np.polyval([0.4, -0.19999999999999996], x), 'color': 'steelblue', 'label': 'f'}
], title='')
save_graph(fig, 'u6_s3_ps1_c01_integrand.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([-0.3, 2.0999999999999996, -3.5973599999999997], x), 'deriv': lambda x: np.polyval([-0.6, 2.0999999999999996], x), 'color': 'steelblue', 'label': 'f'}
], title='')
save_graph(fig, 'u6_s3_xp_c04_integrand.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([-0.2, -1.0, -1.1954700000000003], x), 'deriv': lambda x: np.polyval([-0.4, -1.0], x), 'color': 'steelblue', 'label': 'f'}
], title='')
save_graph(fig, 'u6_s4_et_b_l01_integrand.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([0.2, 0.6000000000000001, 0.40789000000000003], x), 'deriv': lambda x: np.polyval([0.4, 0.6000000000000001], x), 'color': 'steelblue', 'label': 'f'}
], title='')
save_graph(fig, 'u6_s4_ps1_l04_integrand.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([-0.3, -0.29999999999999993, 1.8015099999999997], x), 'deriv': lambda x: np.polyval([-0.6, -0.29999999999999993], x), 'color': 'steelblue', 'label': 'f'}
], title='')
save_graph(fig, 'u6_s4_ps2_l03_integrand.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([0.2, 0.8, 0.6091600000000001], x), 'deriv': lambda x: np.polyval([0.4, 0.8], x), 'color': 'steelblue', 'label': 'f'}
], title='')
save_graph(fig, 'u6_s4_wu3_l01_integrand.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([0.3, 1.2, 0.90087], x), 'deriv': lambda x: np.polyval([0.6, 1.2], x), 'color': 'steelblue', 'label': 'f'}
], title='')
save_graph(fig, 'u6_s4_xp_l01_integrand.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([-0.3, 2.0999999999999996, -3.5951099999999996], x), 'deriv': lambda x: np.polyval([-0.6, 2.0999999999999996], x), 'color': 'steelblue', 'label': 'f'}
], title='')
save_graph(fig, 'u6_sum_v1_q13_sum_integrand.png')
plt.close(fig)
...
make_piecewise_graph(ax, [
    {'expr': lambda x, m=-4.5, b=4.0: m*x+b, 'deriv': lambda x, m=-4.5: np.zeros_like(x,dtype=float)+m, 'domain': (0,2), 'include_left': True, 'include_right': False, 'arrow_left': False, 'arrow_right': False},
    {'expr': lambda x, m=1.5, b=-8.0: m*x+b, 'deriv': lambda x, m=1.5: np.zeros_like(x,dtype=float)+m, 'domain': (2,4), 'include_left': True, 'include_right': False, 'arrow_left': False, 'arrow_right': False},
    {'expr': lambda x, m=-0.5, b=0.0: m*x+b, 'deriv': lambda x, m=-0.5: np.zeros_like(x,dtype=float)+m, 'domain': (4,6), 'include_left': True, 'include_right': True, 'arrow_left': False, 'arrow_right': False}
], title='')
save_graph(fig, 'u6_sum_v1_q16_sum_rate.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([0.3, 0.6, -2.39244], x), 'deriv': lambda x: np.polyval([0.6, 0.6], x), 'color': 'steelblue', 'label': 'f'}
], title='')
save_graph(fig, 'u6_sum_v1_q18_sum_integrand.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([-0.2, -1.0, -0.79771], x), 'deriv': lambda x: np.polyval([-0.4, -1.0], x), 'color': 'steelblue', 'label': 'f'}
], title='')
save_graph(fig, 'u6_sum_v2_q13_sum_integrand.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_piecewise_graph(ax, [
    {'expr': lambda x, m=0.5, b=-2.0: m*x+b, 'deriv': lambda x, m=0.5: np.zeros_like(x,dtype=float)+m, 'domain': (0,2), 'include_left': True, 'include_right': False, 'arrow_left': False, 'arrow_right': False},
    {'expr': lambda x, m=-0.5, b=0.0: m*x+b, 'deriv': lambda x, m=-0.5: np.zeros_like(x,dtype=float)+m, 'domain': (2,4), 'include_left': True, 'include_right': False, 'arrow_left': False, 'arrow_right': False},
    {'expr': lambda x, m=2.5, b=-12.0: m*x+b, 'deriv': lambda x, m=2.5: np.zeros_like(x,dtype=float)+m, 'domain': (4,6), 'include_left': True, 'include_right': True, 'arrow_left': False, 'arrow_right': False}
], title='')
save_graph(fig, 'u6_sum_v2_q16_sum_rate.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([0.3, 0.0, -0.29351], x), 'deriv': lambda x: np.polyval([0.6, 0.0], x), 'color': 'steelblue', 'label': 'f'}
], title='')
save_graph(fig, 'u6_sum_v2_q18_sum_integrand.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([-0.2, -0.6000000000000001, -0.39496000000000003], x), 'deriv': lambda x: np.polyval([-0.4, -0.6000000000000001], x), 'color': 'steelblue', 'label': 'f'}
], title='')
save_graph(fig, 'u6_sum_v3_q13_sum_integrand.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_piecewise_graph(ax, [
    {'expr': lambda x, m=2.5, b=-2.0: m*x+b, 'deriv': lambda x, m=2.5: np.zeros_like(x,dtype=float)+m, 'domain': (0,2), 'include_left': True, 'include_right': False, 'arrow_left': False, 'arrow_right': False},
    {'expr': lambda x, m=0.5, b=2.0: m*x+b, 'deriv': lambda x, m=0.5: np.zeros_like(x,dtype=float)+m, 'domain': (2,4), 'include_left': True, 'include_right': False, 'arrow_left': False, 'arrow_right': False},
    {'expr': lambda x, m=-1.5, b=10.0: m*x+b, 'deriv': lambda x, m=-1.5: np.zeros_like(x,dtype=float)+m, 'domain': (4,6), 'include_left': True, 'include_right': True, 'arrow_left': False, 'arrow_right': False}
], title='')
save_graph(fig, 'u6_sum_v3_q16_sum_rate.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([-0.2, -0.8, -0.5979900000000001], x), 'deriv': lambda x: np.polyval([-0.4, -0.8], x), 'color': 'steelblue', 'label': 'f'}
], title='')
save_graph(fig, 'u6_sum_v3_q18_sum_integrand.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([-0.3, 1.2, -0.89838], x), 'deriv': lambda x: np.polyval([-0.6, 1.2], x), 'color': 'steelblue', 'label': 'f'}
], title='')
save_graph(fig, 'u6_sum_v4_q13_sum_integrand.png')
plt.close(fig)
...
save_graph(fig, 'u6_sum_v4_q16_sum_rate.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([0.3, -0.5999999999999999, -0.8902699999999999], x), 'deriv': lambda x: np.polyval([0.6, -0.5999999999999999], x), 'color': 'steelblue', 'label': 'f'}
], title='')
save_graph(fig, 'u6_sum_v4_q18_sum_integrand.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([-0.2, 0.2, 0.40875], x), 'deriv': lambda x: np.polyval([-0.4, 0.2], x), 'color': 'steelblue', 'label': 'f'}
], title='')
save_graph(fig, 'u6_sum_v5_q13_sum_integrand.png')
plt.close(fig)
...
save_graph(fig, 'u6_sum_v5_q16_sum_rate.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([-0.3, 2.0999999999999996, -3.5939499999999995], x), 'deriv': lambda x: np.polyval([-0.6, 2.0999999999999996], x), 'color': 'steelblue', 'label': 'f'}
], title='')
save_graph(fig, 'u6_sum_v5_q18_sum_integrand.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([-0.3, 0.3, 0.60868], x), 'deriv': lambda x: np.polyval([-0.6, 0.3], x), 'color': 'steelblue', 'label': 'f'}
], title='')
save_graph(fig, 'u6_sum_v6_q13_sum_integrand.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_piecewise_graph(ax, [
    {'expr': lambda x, m=0.0, b=-3.0: m*x+b, 'deriv': lambda x, m=0.0: np.zeros_like(x,dtype=float)+m, 'domain': (0,2), 'include_left': True, 'include_right': False, 'arrow_left': False, 'arrow_right': False},
    {'expr': lambda x, m=2.5, b=-8.0: m*x+b, 'deriv': lambda x, m=2.5: np.zeros_like(x,dtype=float)+m, 'domain': (2,4), 'include_left': True, 'include_right': False, 'arrow_left': False, 'arrow_right': False},
    {'expr': lambda x, m=-0.5, b=4.0: m*x+b, 'deriv': lambda x, m=-0.5: np.zeros_like(x,dtype=float)+m, 'domain': (4,6), 'include_left': True, 'include_right': True, 'arrow_left': False, 'arrow_right': False}
], title='')
save_graph(fig, 'u6_sum_v6_q16_sum_rate.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([-0.3, 0.6, 2.40308], x), 'deriv': lambda x: np.polyval([-0.6, 0.6], x), 'color': 'steelblue', 'label': 'f'}
], title='')
save_graph(fig, 'u6_sum_v6_q18_sum_integrand.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([-0.2, -0.2, 0.40480000000000005], x), 'deriv': lambda x: np.polyval([-0.4, -0.2], x), 'color': 'steelblue', 'label': 'f'}
], title='')
save_graph(fig, 'u6_sum_v7_q13_sum_integrand.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_piecewise_graph(ax, [
    {'expr': lambda x, m=-3.0, b=3.0: m*x+b, 'deriv': lambda x, m=-3.0: np.zeros_like(x,dtype=float)+m, 'domain': (0,2), 'include_left': True, 'include_right': False, 'arrow_left': False, 'arrow_right': False},
    {'expr': lambda x, m=3.5, b=-10.0: m*x+b, 'deriv': lambda x, m=3.5: np.zeros_like(x,dtype=float)+m, 'domain': (2,4), 'include_left': True, 'include_right': False, 'arrow_left': False, 'arrow_right': False},
    {'expr': lambda x, m=-0.5, b=6.0: m*x+b, 'deriv': lambda x, m=-0.5: np.zeros_like(x,dtype=float)+m, 'domain': (4,6), 'include_left': True, 'include_right': True, 'arrow_left': False, 'arrow_right': False}
], title='')
save_graph(fig, 'u6_sum_v7_q16_sum_rate.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([-0.3, 0.29999999999999993, 1.8086699999999998], x), 'deriv': lambda x: np.polyval([-0.6, 0.29999999999999993], x), 'color': 'steelblue', 'label': 'f'}
], title='')
save_graph(fig, 'u6_sum_v7_q18_sum_integrand.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([-0.2, 0.8, -0.5983600000000001], x), 'deriv': lambda x: np.polyval([-0.4, 0.8], x), 'color': 'steelblue', 'label': 'f'}
], title='')
save_graph(fig, 'u6_sum_v8_q13_sum_integrand.png')
plt.close(fig)
...
save_graph(fig, 'u6_sum_v8_q16_sum_rate.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([0.3, -0.3, -0.5999], x), 'deriv': lambda x: np.polyval([0.6, -0.3], x), 'color': 'steelblue', 'label': 'f'}
], title='')
save_graph(fig, 'u6_sum_v8_q18_sum_integrand.png')
plt.close(fig)
