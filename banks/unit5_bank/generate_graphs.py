...
# ============================================================================
# UNIT 5 BANK GENERATED FIGURES - APPENDED BELOW FINAL APPROVED MARKER
# ============================================================================

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([-0.12, -0.36, 0.48, 1.44932], x), 'deriv': lambda x: np.polyval([-0.36, -0.72, 0.48], x), 'color': 'steelblue', 'label': "f'"}
], title='')
save_graph(fig, 'u5_fa_d3_02_v1_strategy_graph.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([0.12, -0.12, -0.48, 0.4861], x), 'deriv': lambda x: np.polyval([0.36, -0.24, -0.48], x), 'color': 'steelblue', 'label': "f'"}
], title='')
save_graph(fig, 'u5_fa_d3_02_v2_strategy_graph.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([-0.12, 0.0, 1.56, -1.43866], x), 'deriv': lambda x: np.polyval([-0.36, 0.0, 1.56], x), 'color': 'steelblue', 'label': "f'"}
], title='')
save_graph(fig, 'u5_fa_d3_02_v3_strategy_graph.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([0.08, -0.08, -1.12, 1.92323], x), 'deriv': lambda x: np.polyval([0.24, -0.16, -1.12], x), 'color': 'steelblue', 'label': "f'"}
], title='')
save_graph(fig, 'u5_fa_d3_02_v4_strategy_graph.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([0.08, -0.32, 0.08, 0.48830999999999997], x), 'deriv': lambda x: np.polyval([0.24, -0.64, 0.08], x), 'color': 'steelblue', 'label': "f'"}
], title='')
save_graph(fig, 'u5_fa_d3_02_v5_strategy_graph.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([-0.12, -0.36, 1.92, 5.76019], x), 'deriv': lambda x: np.polyval([-0.36, -0.72, 1.92], x), 'color': 'steelblue', 'label': "f'"}
], title='')
save_graph(fig, 'u5_fa_d3_02_v6_strategy_graph.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([-0.08, 0.32, 0.72, -2.87555], x), 'deriv': lambda x: np.polyval([-0.24, 0.64, 0.72], x), 'color': 'steelblue', 'label': "f'"}
], title='')
save_graph(fig, 'u5_fa_d3_02_v7_strategy_graph.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([-0.08, 0.72, -2.08, 1.9260899999999999], x), 'deriv': lambda x: np.polyval([-0.24, 1.44, -2.08], x), 'color': 'steelblue', 'label': "f'"}
], title='')
save_graph(fig, 'u5_fa_d3_02_v8_strategy_graph.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([-0.25, 0.25, 0.50306], x), 'deriv': lambda x: np.polyval([-0.5, 0.25], x), 'color': 'steelblue', 'label': "f'"}
], title='')
save_graph(fig, 'u5_s2_note_ex04_fprime_graph.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([-0.35, -0.6999999999999998, 1.05049], x), 'deriv': lambda x: np.polyval([-0.7, -0.6999999999999998], x), 'color': 'steelblue', 'label': "f'"}
], title='')
save_graph(fig, 'u5_s2_note_yti03_fprime_graph.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([0.35, -1.0499999999999998, -1.3912799999999999], x), 'deriv': lambda x: np.polyval([0.7, -1.0499999999999998], x), 'color': 'steelblue', 'label': "f'"}
], title='')
save_graph(fig, 'u5_s2_ps1_c03_fprime_graph.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([0.35, 1.75, 1.4096899999999999], x), 'deriv': lambda x: np.polyval([0.7, 1.75], x), 'color': 'steelblue', 'label': "f'"}
], title='')
save_graph(fig, 'u5_s2_ps2_c02_fprime_graph.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([0.35, 0.0, -3.1476999999999995], x), 'deriv': lambda x: np.polyval([0.7, 0.0], x), 'color': 'steelblue', 'label': "f'"}
], title='')
save_graph(fig, 'u5_s2_wu3_c01_fprime_graph.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([-0.25, 1.25, -0.99722], x), 'deriv': lambda x: np.polyval([-0.5, 1.25], x), 'color': 'steelblue', 'label': "f''"}
], title='')
save_graph(fig, 'u5_s3_note_ex04_fdoubleprime_graph.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([-0.35, 0.6999999999999998, 1.0513599999999999], x), 'deriv': lambda x: np.polyval([-0.7, 0.6999999999999998], x), 'color': 'steelblue', 'label': "f''"}
], title='')
save_graph(fig, 'u5_s3_note_yti03_fdoubleprime_graph.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([-0.35, 1.75, -1.39285], x), 'deriv': lambda x: np.polyval([-0.7, 1.75], x), 'color': 'steelblue', 'label': "f''"}
], title='')
save_graph(fig, 'u5_s3_ps1_c03_fdoubleprime_graph.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([-0.35, -1.75, -1.39174], x), 'deriv': lambda x: np.polyval([-0.7, -1.75], x), 'color': 'steelblue', 'label': "f''"}
], title='')
save_graph(fig, 'u5_s3_ps2_c02_fdoubleprime_graph.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([-0.35, 0.35, 0.70024], x), 'deriv': lambda x: np.polyval([-0.7, 0.35], x), 'color': 'steelblue', 'label': "f'"}
], title='')
save_graph(fig, 'u5_s3_ps2_l05_fprime_graph.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([0.35, 0.35, -0.6995399999999999], x), 'deriv': lambda x: np.polyval([0.7, 0.35], x), 'color': 'steelblue', 'label': "f'"}
], title='')
save_graph(fig, 'u5_s3_wu1_l01_fprime_graph.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([0.25, -0.25, -2.99084], x), 'deriv': lambda x: np.polyval([0.5, -0.25], x), 'color': 'steelblue', 'label': "f''"}
], title='')
save_graph(fig, 'u5_s3_wu3_c01_fdoubleprime_graph.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([0.25, -1.0, 0.75604], x), 'deriv': lambda x: np.polyval([0.5, -1.0], x), 'color': 'steelblue', 'label': "f'"}
], title='')
save_graph(fig, 'u5_s3_xp_l03_fprime_graph.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([-0.08, -0.24, 1.28, 3.8404], x), 'deriv': lambda x: np.polyval([-0.24, -0.48, 1.28], x), 'color': 'steelblue', 'label': "f'"}
], title='')
save_graph(fig, 'u5_s4_cyu_c01_fprime_connection.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([0.12, 0.96, 2.28, 1.44766], x), 'deriv': lambda x: np.polyval([0.36, 1.92, 2.28], x), 'color': 'steelblue', 'label': "f'"}
], title='')
save_graph(fig, 'u5_s4_et_c_c02_fprime_connection.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([-0.12, 0.0, 0.84, -0.71736], x), 'deriv': lambda x: np.polyval([-0.36, 0.0, 0.84], x), 'color': 'steelblue', 'label': "f'"}
], title='')
save_graph(fig, 'u5_s4_note_ex02_fprime_connection.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([0.08333333333333333, -0.3333333333333333, 0.0, 0.6666666666666666, -1.2466666666666668], x), 'deriv': lambda x: np.polyval([0.3333333333333333, -1.0, 0.0, 0.6666666666666666], x), 'color': 'steelblue', 'label': 'f'},
    {'expr': lambda x: np.polyval([0.3333333333333333, -1.0, 0.0, 0.8366666666666667], x), 'deriv': lambda x: np.polyval([1.0, -2.0, 0.0], x), 'color': 'firebrick', 'label': "f'"},
    {'expr': lambda x: np.polyval([1.0, -2.0, 0.17], x), 'deriv': lambda x: np.polyval([2.0, -2.0], x), 'color': 'darkorange', 'label': "f''"}
], title='')
save_graph(fig, 'u5_s4_note_ex04_triple_graph.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([-0.08, -0.16, 0.88, 0.96983], x), 'deriv': lambda x: np.polyval([-0.24, -0.32, 0.88], x), 'color': 'steelblue', 'label': "f'"}
], title='')
save_graph(fig, 'u5_s4_note_yti01_fprime_connection.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([0.08333333333333333, -0.3333333333333333, 0.0, 0.6666666666666666, -1.4166666666666667], x), 'deriv': lambda x: np.polyval([0.3333333333333333, -1.0, 0.0, 0.6666666666666666], x), 'color': 'steelblue', 'label': 'f'},
    {'expr': lambda x: np.polyval([0.3333333333333333, -1.0, 0.0, 0.6666666666666666], x), 'deriv': lambda x: np.polyval([1.0, -2.0, 0.0], x), 'color': 'firebrick', 'label': "f'"},
    {'expr': lambda x: np.polyval([1.0, -2.0, 0.0], x), 'deriv': lambda x: np.polyval([2.0, -2.0], x), 'color': 'darkorange', 'label': "f''"}
], title='')
save_graph(fig, 'u5_s4_note_yti03_triple_graph.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([0.12, 0.12, -1.2, 0.96655], x), 'deriv': lambda x: np.polyval([0.36, 0.24, -1.2], x), 'color': 'steelblue', 'label': "f'"}
], title='')
save_graph(fig, 'u5_s4_ps1_c01_fprime_connection.png')
plt.close(fig)
...
save_graph(fig, 'u5_s4_ps1_c03_triple_graph.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([0.08333333333333333, 0.0, -0.5, 0.0, 1.0], x), 'deriv': lambda x: np.polyval([0.3333333333333333, 0.0, -1.0, 0.0], x), 'color': 'steelblue', 'label': 'f'},
    {'expr': lambda x: np.polyval([0.3333333333333333, 0.0, -1.0, 0.0], x), 'deriv': lambda x: np.polyval([1.0, 0.0, -1.0], x), 'color': 'firebrick', 'label': "f'"},
    {'expr': lambda x: np.polyval([1.0, 0.0, -1.0], x), 'deriv': lambda x: np.polyval([2.0, 0.0], x), 'color': 'darkorange', 'label': "f''"}
], title='')
save_graph(fig, 'u5_s4_ps2_c02_triple_graph.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([0.35, 1.4, 1.05727], x), 'deriv': lambda x: np.polyval([0.7, 1.4], x), 'color': 'steelblue', 'label': "f''"}
], title='')
save_graph(fig, 'u5_s4_ps2_l05_fdoubleprime_graph.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([-0.35, -0.35, 0.70271], x), 'deriv': lambda x: np.polyval([-0.7, -0.35], x), 'color': 'steelblue', 'label': "f''"}
], title='')
save_graph(fig, 'u5_s4_wu1_l01_fdoubleprime_graph.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([0.08333333333333333, -0.3333333333333333, 0.0, 0.6666666666666666, -0.9066666666666668], x), 'deriv': lambda x: np.polyval([0.3333333333333333, -1.0, 0.0, 0.6666666666666666], x), 'color': 'steelblue', 'label': 'f'},
    {'expr': lambda x: np.polyval([0.3333333333333333, -1.0, 0.0, 1.1766666666666665], x), 'deriv': lambda x: np.polyval([1.0, -2.0, 0.0], x), 'color': 'firebrick', 'label': "f'"},
    {'expr': lambda x: np.polyval([1.0, -2.0, 0.51], x), 'deriv': lambda x: np.polyval([2.0, -2.0], x), 'color': 'darkorange', 'label': "f''"}
], title='')
save_graph(fig, 'u5_s4_wu3_c01_triple_graph.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([-0.08, 0.24, 0.8, -1.9154], x), 'deriv': lambda x: np.polyval([-0.24, 0.48, 0.8], x), 'color': 'steelblue', 'label': "f'"}
], title='')
save_graph(fig, 'u5_s4_xp_c04_fprime_connection.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([-0.25, 1.5, -1.9979], x), 'deriv': lambda x: np.polyval([-0.5, 1.5], x), 'color': 'steelblue', 'label': "f''"}
], title='')
save_graph(fig, 'u5_s4_xp_l03_fdoubleprime_graph.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([0.08, 0.08, -0.8, 0.64227], x), 'deriv': lambda x: np.polyval([0.24, 0.16, -0.8], x), 'color': 'steelblue', 'label': "f'"}
], title='')
save_graph(fig, 'u5_s5_et_b_l01_fprime_connection.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([0.08, 0.32, -0.08, -0.31544], x), 'deriv': lambda x: np.polyval([0.24, 0.64, -0.08], x), 'color': 'steelblue', 'label': "f'"}
], title='')
save_graph(fig, 'u5_s5_ps1_l04_fprime_connection.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([0.12, 0.12, -0.48, -0.47524], x), 'deriv': lambda x: np.polyval([0.36, 0.24, -0.48], x), 'color': 'steelblue', 'label': "f'"}
], title='')
save_graph(fig, 'u5_s5_ps2_l03_fprime_connection.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([0.08333333333333333, -0.3333333333333333, 0.0, 0.6666666666666666, -1.0766666666666669], x), 'deriv': lambda x: np.polyval([0.3333333333333333, -1.0, 0.0, 0.6666666666666666], x), 'color': 'steelblue', 'label': 'f'},
    {'expr': lambda x: np.polyval([0.3333333333333333, -1.0, 0.0, 1.0066666666666666], x), 'deriv': lambda x: np.polyval([1.0, -2.0, 0.0], x), 'color': 'firebrick', 'label': "f'"},
    {'expr': lambda x: np.polyval([1.0, -2.0, 0.34], x), 'deriv': lambda x: np.polyval([2.0, -2.0], x), 'color': 'darkorange', 'label': "f''"}
], title='')
save_graph(fig, 'u5_s5_ps2_l05_triple_graph.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([0.08333333333333333, 0.3333333333333333, 0.0, -0.6666666666666666, 0.7533333333333334], x), 'deriv': lambda x: np.polyval([0.3333333333333333, 1.0, 0.0, -0.6666666666666666], x), 'color': 'steelblue', 'label': 'f'},
    {'expr': lambda x: np.polyval([0.3333333333333333, 1.0, 0.0, -0.4966666666666666], x), 'deriv': lambda x: np.polyval([1.0, 2.0, 0.0], x), 'color': 'firebrick', 'label': "f'"},
    {'expr': lambda x: np.polyval([1.0, 2.0, 0.17], x), 'deriv': lambda x: np.polyval([2.0, 2.0], x), 'color': 'darkorange', 'label': "f''"}
], title='')
save_graph(fig, 'u5_s5_wu1_l01_triple_graph.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([0.12, -0.96, 2.28, -1.43954], x), 'deriv': lambda x: np.polyval([0.36, -1.92, 2.28], x), 'color': 'steelblue', 'label': "f'"}
], title='')
save_graph(fig, 'u5_s5_wu3_l01_fprime_connection.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([-0.12, -0.12, 0.48, 0.48363999999999996], x), 'deriv': lambda x: np.polyval([-0.36, -0.24, 0.48], x), 'color': 'steelblue', 'label': "f'"}
], title='')
save_graph(fig, 'u5_s5_xp_l01_fprime_connection.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([0.08333333333333333, 0.3333333333333333, 0.0, -0.6666666666666666, 0.5833333333333334], x), 'deriv': lambda x: np.polyval([0.3333333333333333, 1.0, 0.0, -0.6666666666666666], x), 'color': 'steelblue', 'label': 'f'},
    {'expr': lambda x: np.polyval([0.3333333333333333, 1.0, 0.0, -0.6666666666666666], x), 'deriv': lambda x: np.polyval([1.0, 2.0, 0.0], x), 'color': 'firebrick', 'label': "f'"},
    {'expr': lambda x: np.polyval([1.0, 2.0, 0.0], x), 'deriv': lambda x: np.polyval([2.0, 2.0], x), 'color': 'darkorange', 'label': "f''"}
], title='')
save_graph(fig, 'u5_s5_xp_l03_triple_graph.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([0.35, 0.0, -1.39383], x), 'deriv': lambda x: np.polyval([0.7, 0.0], x), 'color': 'steelblue', 'label': "f'"}
], title='')
save_graph(fig, 'u5_sum_v1_q07_sum_fprime.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([0.25, -0.75, 0.50443], x), 'deriv': lambda x: np.polyval([0.5, -0.75], x), 'color': 'steelblue', 'label': "f''"}
], title='')
save_graph(fig, 'u5_sum_v1_q11_sum_fdoubleprime.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([-0.08, -0.08, 1.28, 1.28457], x), 'deriv': lambda x: np.polyval([-0.24, -0.16, 1.28], x), 'color': 'steelblue', 'label': "f'"}
], title='')
save_graph(fig, 'u5_sum_v1_q16_sum_connection.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([-0.35, -1.75, -1.3945999999999998], x), 'deriv': lambda x: np.polyval([-0.7, -1.75], x), 'color': 'steelblue', 'label': "f'"}
], title='')
save_graph(fig, 'u5_sum_v2_q07_sum_fprime.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([-0.25, 0.0, 1.0025], x), 'deriv': lambda x: np.polyval([-0.5, 0.0], x), 'color': 'steelblue', 'label': "f''"}
], title='')
save_graph(fig, 'u5_sum_v2_q11_sum_fdoubleprime.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([0.12, 0.0, -1.56, -1.43027], x), 'deriv': lambda x: np.polyval([0.36, 0.0, -1.56], x), 'color': 'steelblue', 'label': "f'"}
], title='')
save_graph(fig, 'u5_sum_v2_q16_sum_connection.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([-0.35, -1.7499999999999998, -2.09826], x), 'deriv': lambda x: np.polyval([-0.7, -1.7499999999999998], x), 'color': 'steelblue', 'label': "f'"}
], title='')
save_graph(fig, 'u5_sum_v3_q07_sum_fprime.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([0.25, 0.0, -3.99539], x), 'deriv': lambda x: np.polyval([0.5, 0.0], x), 'color': 'steelblue', 'label': "f''"}
], title='')
save_graph(fig, 'u5_sum_v3_q11_sum_fdoubleprime.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([-0.12, -0.12, 1.92, 1.9275799999999998], x), 'deriv': lambda x: np.polyval([-0.36, -0.24, 1.92], x), 'color': 'steelblue', 'label': "f'"}
], title='')
save_graph(fig, 'u5_sum_v3_q16_sum_connection.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([-0.25, 1.75, -2.99585], x), 'deriv': lambda x: np.polyval([-0.5, 1.75], x), 'color': 'steelblue', 'label': "f'"}
], title='')
save_graph(fig, 'u5_sum_v4_q07_sum_fprime.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([0.35, 0.34999999999999987, -2.09026], x), 'deriv': lambda x: np.polyval([0.7, 0.34999999999999987], x), 'color': 'steelblue', 'label': "f''"}
], title='')
save_graph(fig, 'u5_sum_v4_q11_sum_fdoubleprime.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([-0.08, 0.64, -1.52, 0.96251], x), 'deriv': lambda x: np.polyval([-0.24, 1.28, -1.52], x), 'color': 'steelblue', 'label': "f'"}
], title='')
save_graph(fig, 'u5_sum_v4_q16_sum_connection.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([-0.35, 0.0, 1.4071], x), 'deriv': lambda x: np.polyval([-0.7, 0.0], x), 'color': 'steelblue', 'label': "f'"}
], title='')
save_graph(fig, 'u5_sum_v5_q07_sum_fprime.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([-0.25, -0.25, 1.50688], x), 'deriv': lambda x: np.polyval([-0.5, -0.25], x), 'color': 'steelblue', 'label': "f''"}
], title='')
save_graph(fig, 'u5_sum_v5_q11_sum_fdoubleprime.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([-0.08, -0.32, -0.08, 0.4863], x), 'deriv': lambda x: np.polyval([-0.24, -0.64, -0.08], x), 'color': 'steelblue', 'label': "f'"}
], title='')
save_graph(fig, 'u5_sum_v5_q16_sum_connection.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([-0.35, -1.0499999999999998, -0.69163], x), 'deriv': lambda x: np.polyval([-0.7, -1.0499999999999998], x), 'color': 'steelblue', 'label': "f'"}
], title='')
save_graph(fig, 'u5_sum_v6_q07_sum_fprime.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([-0.35, -1.0499999999999998, 1.4096], x), 'deriv': lambda x: np.polyval([-0.7, -1.0499999999999998], x), 'color': 'steelblue', 'label': "f''"}
], title='')
save_graph(fig, 'u5_sum_v6_q11_sum_fdoubleprime.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([0.12, 0.12, -0.48, -0.47624], x), 'deriv': lambda x: np.polyval([0.36, 0.24, -0.48], x), 'color': 'steelblue', 'label': "f'"}
], title='')
save_graph(fig, 'u5_sum_v6_q16_sum_connection.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([0.25, -0.5, -0.74057], x), 'deriv': lambda x: np.polyval([0.5, -0.5], x), 'color': 'steelblue', 'label': "f'"}
], title='')
save_graph(fig, 'u5_sum_v7_q07_sum_fprime.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([-0.25, 0.25, 1.50492], x), 'deriv': lambda x: np.polyval([-0.5, 0.25], x), 'color': 'steelblue', 'label': "f''"}
], title='')
save_graph(fig, 'u5_sum_v7_q11_sum_fdoubleprime.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([-0.12, -0.12, 0.48, 0.48945], x), 'deriv': lambda x: np.polyval([-0.36, -0.24, 0.48], x), 'color': 'steelblue', 'label': "f'"}
], title='')
save_graph(fig, 'u5_sum_v7_q16_sum_connection.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([-0.35, 0.0, 1.40092], x), 'deriv': lambda x: np.polyval([-0.7, 0.0], x), 'color': 'steelblue', 'label': "f'"}
], title='')
save_graph(fig, 'u5_sum_v8_q07_sum_fprime.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([0.35, -0.34999999999999987, -2.0900099999999995], x), 'deriv': lambda x: np.polyval([0.7, -0.34999999999999987], x), 'color': 'steelblue', 'label': "f''"}
], title='')
save_graph(fig, 'u5_sum_v8_q11_sum_fdoubleprime.png')
plt.close(fig)

fig, ax = plt.subplots(figsize=(3.5, 3.5))
make_standard_graph(ax, [
    {'expr': lambda x: np.polyval([0.08, 0.32, -0.08, -0.3184], x), 'deriv': lambda x: np.polyval([0.24, 0.64, -0.08], x), 'color': 'steelblue', 'label': "f'"}
], title='')
save_graph(fig, 'u5_sum_v8_q16_sum_connection.png')
plt.close(fig)
