...
SPREADSHEET_ID = "1R_0ibg-6CYIWuPGk8WMQedzPGufZWgalXnbsQEELRgU"
...
<div class="wrapper">
  <header class="titlebar">
    <h1>AP Calculus AB <span class="small">– Agenda 2026-2027</span></h1>
  </header>
  ...
  <div class="calendar-wrap">
    <table aria-label="AP Calculus AB student agenda">
      {current_html}
      {all_weeks_html}
    </table>
  </div>
