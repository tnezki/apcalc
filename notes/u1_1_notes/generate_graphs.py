...
# UNIT 1 SECTION 1.1 NOTES GRAPH GENERATION BLOCKS
...
{'expr': lambda x: np.full_like(x,4,dtype=float), 'deriv': lambda x: np.zeros_like(x,dtype=float), 'domain': (-2,-2), 'include_left': True, 'include_right': True, 'arrow_left': False, 'arrow_right': False}], title='')
save_graph(fig, 'u1_s1_notes_limit_vs_value.png')
plt.close(fig)
