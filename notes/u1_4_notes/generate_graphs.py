...
# UNIT 1 SECTION 1.4 NOTES GRAPH GENERATION BLOCKS
...
plt.close(fig)
fig, ax = plt.subplots(figsize=(3.5,3.5))
make_piecewise_graph(ax, [{'expr': lambda x: -0.4*(x-(1))+(2), 'deriv': lambda x: np.full_like(x,-0.4,dtype=float), 'domain': (-10,1), 'include_left': True, 'include_right': False, 'arrow_left': True, 'arrow_right': False},
...
save_graph(fig, 'u1_s4_notes_removable_example.png')
plt.close(fig)
